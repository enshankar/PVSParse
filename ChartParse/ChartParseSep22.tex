...
% 			\caption{\small Condition under which a cell can be marked as \texttt{fail}}
% 			\label{pvs:goodfail}
% \end{figure}
...
% 			\caption{\small Condition under which a cell represents a fully detected \texttt{loop}}
% 			\label{pvs:goodloop}
%                       \end{figure}
...
%     \vspace*{-4mm}
% \caption{\small Predicate subtype declaration for \texttt{finer\_entry}}
...
%     \vspace*{-4mm}
% \caption{\small \texttt{newentry} definition for \texttt{check(n1)}}
...
%     \vspace*{-4mm}
% \caption{\small \texttt{newentry} definition for \texttt{neg(n1)}}
...
% \caption{\small The termination measure for the parser}
% \label{pvs:size}
% \end{figure}
...
%     \vspace*{-4mm}
% \caption{\small The termination state}
% \label{pvs:endstate}
% \end{figure}
