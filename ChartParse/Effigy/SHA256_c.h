...
typedef struct actual_SHA256_array_0_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr;} * actual_SHA256_array_0_t;
...
struct SHA256_funtype_1_s;
        typedef struct SHA256_funtype_1_s * SHA256_funtype_1_t;

struct SHA256_funtype_1_ftbl_s {uint32_t (* fptr)(struct SHA256_funtype_1_s *, mpz_ptr_t);
        uint32_t (* mptr)(struct SHA256_funtype_1_s *, mpz_ptr_t);
        void (* rptr)(struct SHA256_funtype_1_s *);
        struct SHA256_funtype_1_s * (* cptr)(struct SHA256_funtype_1_s *);};
typedef struct SHA256_funtype_1_ftbl_s * SHA256_funtype_1_ftbl_t;

struct SHA256_funtype_1_hashentry_s {uint32_t keyhash; mpz_ptr_t key; uint32_t value;}; 
typedef struct SHA256_funtype_1_hashentry_s SHA256_funtype_1_hashentry_t;

struct SHA256_funtype_1_htbl_s {uint32_t size; uint32_t num_entries; SHA256_funtype_1_hashentry_t * data;}; 
typedef struct SHA256_funtype_1_htbl_s * SHA256_funtype_1_htbl_t;

struct SHA256_funtype_1_s {uint32_t count;
        SHA256_funtype_1_ftbl_t ftbl;
        SHA256_funtype_1_htbl_t htbl;};
typedef struct SHA256_funtype_1_s * SHA256_funtype_1_t;

extern void release_SHA256_funtype_1(SHA256_funtype_1_t x);

extern SHA256_funtype_1_t copy_SHA256_funtype_1(SHA256_funtype_1_t x);
...
extern SHA256_funtype_1_t update_SHA256_funtype_1(SHA256_funtype_1_t a, mpz_ptr_t i, uint32_t v);

extern bool_t equal_SHA256_funtype_1(SHA256_funtype_1_t x, SHA256_funtype_1_t y);



struct SHA256_record_2_s {
        uint32_t count; 
        mpz_t length;
        SHA256_funtype_1_t seq;};
typedef struct SHA256_record_2_s * SHA256_record_2_t;

extern SHA256_record_2_t new_SHA256_record_2(void);

extern void release_SHA256_record_2(SHA256_record_2_t x);

extern SHA256_record_2_t copy_SHA256_record_2(SHA256_record_2_t x);

extern bool_t equal_SHA256_record_2(SHA256_record_2_t x, SHA256_record_2_t y);
typedef struct actual_SHA256_record_2_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr;} * actual_SHA256_record_2_t;

void release_SHA256_record_2_ptr(pointer_t x, type_actual_t SHA256_record_2);
extern bool_t equal_SHA256_record_2_ptr(pointer_t x, pointer_t y, actual_SHA256_record_2_t T);

actual_SHA256_record_2_t actual_SHA256_record_2(void);

extern SHA256_record_2_t update_SHA256_record_2_length(SHA256_record_2_t x, mpz_ptr_t v);

extern SHA256_record_2_t update_SHA256_record_2_seq(SHA256_record_2_t x, SHA256_funtype_1_t v);



struct SHA256_array_3_s { uint32_t count;
        uint32_t size;
         uint32_t max;
         uint32_t elems[]; };
typedef struct SHA256_array_3_s * SHA256_array_3_t;

extern SHA256_array_3_t new_SHA256_array_3(uint32_t size);

extern void release_SHA256_array_3(SHA256_array_3_t x);

extern SHA256_array_3_t copy_SHA256_array_3(SHA256_array_3_t x);

extern bool_t equal_SHA256_array_3(SHA256_array_3_t x, SHA256_array_3_t y);
typedef struct actual_SHA256_array_3_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr;} * actual_SHA256_array_3_t;

void release_SHA256_array_3_ptr(pointer_t x, type_actual_t SHA256_array_3);
extern bool_t equal_SHA256_array_3_ptr(pointer_t x, pointer_t y, type_actual_t T);

actual_SHA256_array_3_t actual_SHA256_array_3(void);

extern SHA256_array_3_t update_SHA256_array_3(SHA256_array_3_t x, uint32_t i, uint32_t v);

extern SHA256_array_3_t upgrade_SHA256_array_3(SHA256_array_3_t x, uint32_t i, uint32_t v);



struct SHA256_record_4_s {
        uint32_t count; 
        uint32_t length;
        SHA256_array_0_t seq;};
typedef struct SHA256_record_4_s * SHA256_record_4_t;

extern SHA256_record_4_t new_SHA256_record_4(void);

extern void release_SHA256_record_4(SHA256_record_4_t x);

extern SHA256_record_4_t copy_SHA256_record_4(SHA256_record_4_t x);

extern bool_t equal_SHA256_record_4(SHA256_record_4_t x, SHA256_record_4_t y);
typedef struct actual_SHA256_record_4_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr;} * actual_SHA256_record_4_t;

void release_SHA256_record_4_ptr(pointer_t x, type_actual_t SHA256_record_4);
extern bool_t equal_SHA256_record_4_ptr(pointer_t x, pointer_t y, actual_SHA256_record_4_t T);

actual_SHA256_record_4_t actual_SHA256_record_4(void);

extern SHA256_record_4_t update_SHA256_record_4_length(SHA256_record_4_t x, uint32_t v);

extern SHA256_record_4_t update_SHA256_record_4_seq(SHA256_record_4_t x, SHA256_array_0_t v);
...
struct SHA256_funtype_5_ftbl_s {SHA256_array_3_t (* fptr)(struct SHA256_funtype_5_s *, uint32_t);
        SHA256_array_3_t (* mptr)(struct SHA256_funtype_5_s *, uint32_t);
...
struct SHA256_funtype_5_hashentry_s {uint32_t keyhash; uint32_t key; SHA256_array_3_t value;}; 
...
extern SHA256_funtype_5_t update_SHA256_funtype_5(SHA256_funtype_5_t a, uint32_t i, SHA256_array_3_t v);

extern bool_t equal_SHA256_funtype_5(SHA256_funtype_5_t x, SHA256_funtype_5_t y);
