...
typedef struct actual_charstrings_array_0_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr;} * actual_charstrings_array_0_t;

void release_charstrings_array_0_ptr(pointer_t x, type_actual_t charstrings_array_0);
...
typedef struct actual_charstrings__charstring_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr;} * actual_charstrings__charstring_t;

void release_charstrings__charstring_ptr(pointer_t x, type_actual_t charstrings__charstring);
...
typedef struct actual_charstrings_record_3_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr;} * actual_charstrings_record_3_t;

void release_charstrings_record_3_ptr(pointer_t x, type_actual_t charstrings_record_3);
