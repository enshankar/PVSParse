...
struct gen_strings_closure_7_s {uint32_t count;
         gen_strings_funtype_0_ftbl_t ftbl;
         gen_strings_funtype_0_htbl_t htbl;
        gen_strings_funtype_0_t fvar_1;};
...
struct gen_strings_closure_9_s;
        typedef struct gen_strings_closure_9_s * gen_strings_closure_9_t;

struct gen_strings_closure_9_s {uint32_t count;
         gen_strings_funtype_0_ftbl_t ftbl;
         gen_strings_funtype_0_htbl_t htbl;
        gen_strings_funtype_0_t fvar_1;};
...
extern gen_strings_closure_9_t new_gen_strings_closure_9(void);

extern void release_gen_strings_closure_9(gen_strings_funtype_0_t closure);

extern gen_strings_closure_9_t copy_gen_strings_closure_9(gen_strings_closure_9_t x);
