...
extern char * json_bytestrings_array_0(bytestrings_array_0_t x);

typedef struct actual_bytestrings_array_0_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr; json_ptr_t json_ptr;} * actual_bytestrings_array_0_t;
extern void release_bytestrings_array_0_ptr(pointer_t x, type_actual_t bytestrings_array_0);

extern bool_t equal_bytestrings_array_0_ptr(pointer_t x, pointer_t y, type_actual_t T);

extern char * json_bytestrings_array_0_ptr(pointer_t x, type_actual_t T);
