...
extern void release_bytevectors__byv(bytevectors__byv_t x, uint32_t n);

extern bytevectors__byv_t copy_bytevectors__byv(bytevectors__byv_t x);

extern bool_t equal_bytevectors__byv(bytevectors__byv_t x, bytevectors__byv_t y, uint32_t n);
typedef struct actual_bytevectors__byv_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr; uint32_t n;} * actual_bytevectors__byv_t;
...
extern bytevectors__byv_t update_bytevectors__byv(bytevectors__byv_t x, uint32_t i, uint8_t v, uint32_t n);

extern bytevectors__byv_t upgrade_bytevectors__byv(bytevectors__byv_t x, uint32_t i, uint8_t v, uint32_t n);
