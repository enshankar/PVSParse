...
extern uint8_t dfa__digitstate2(uint8_t ivar_4);

extern uint8_t dfa__digitstate3(uint8_t ivar_5);

extern dfa__dfa_t dfa__digitDfa(void);

extern uint8_t dfa__tokenstate1(uint8_t ivar_4);

extern uint8_t dfa__tokenstate2(uint8_t ivar_5);

extern uint8_t dfa__tokenstate3(uint8_t ivar_5);

extern dfa__dfa_t dfa__tokenDfa(void);

extern uint8_t dfa__wspacestate1(uint8_t ivar_5);
