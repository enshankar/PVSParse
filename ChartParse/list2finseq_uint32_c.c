...
uint32_t lookup_list2finseq_uint32_funtype_0(list2finseq_uint32_funtype_0_htbl_t htbl, mpz_ptr_t i, uint32_t ihash){
        ...
        int64_t tmp11557 = mpz_cmp_ui(data.key, 0);
        keyzero = (tmp11557 == 0);
        bool_t keymatch;
        int64_t tmp11558 = mpz_cmp(data.key, i);
        keymatch = (tmp11558 == 0);
...
list2finseq_uint32_funtype_0_t dupdate_list2finseq_uint32_funtype_0(list2finseq_uint32_funtype_0_t a, mpz_ptr_t i, uint32_t v){
        ...
        if (num_entries/3 >  size/5){//resize data
                ...
                for (uint32_t j = 0; j < size; j++){//transfer entries
                        ...
                        bool_t keyzero;
                        int64_t tmp11559 = mpz_cmp_ui(data[j].key, 0);keyzero = (tmp11559 == 0);
                        if (!keyzero || keyhash != 0){
                                uint32_t new_loc = keyhash ^ new_mask;
                                int64_t tmp11560 = mpz_cmp_ui(new_data[new_loc].key, 0);
                                keyzero = (tmp11560 == 0);
                                while (keyzero && new_data[new_loc].keyhash == 0){
                                        new_loc++;
                                        new_loc = new_loc ^ new_mask;

                                        int64_t tmp11561 = mpz_cmp_ui(new_data[new_loc].key, 0);
                                        keyzero = (tmp11561 == 0);
                                }
        ...
        int64_t tmp11562 = mpz_cmp_ui(hentry.key, 0);hentrykeyzero = (tmp11562 == 0);
...
extern list2finseq_uint32_record_1_t h_list2finseq_uint32_closure_3(list_adt__list_adt_t ivar_5){
        ...
        list2finseq_uint32_closure_4_t cl11566;
        cl11566 = new_list2finseq_uint32_closure_4();
        cl11566->fvar_1 = (list_adt__list_adt_t)ivar_5;
        if (cl11566->fvar_1 != NULL) cl11566->fvar_1->count++;
        release_list_adt__list_adt(ivar_5);
        ivar_35 = (list2finseq_uint32_funtype_0_t)cl11566;
        list2finseq_uint32_record_1_t tmp11567 = new_list2finseq_uint32_record_1();;
        result = (list2finseq_uint32_record_1_t)tmp11567;
        mpz_init(tmp11567->length);
        mpz_set(tmp11567->length, ivar_17);
        mpz_clear(ivar_17);
        tmp11567->seq = (list2finseq_uint32_funtype_0_t)ivar_35;
...
if (closure->htbl != NULL){
        ...
        bool_t keyzero;
         int64_t tmp11564 = mpz_cmp_ui(entry.key, 0);
         keyzero = (tmp11564 == 0);
...
extern list2finseq_uint32_funtype_2_t list2finseq_uint32__list2finseq(void){
        ...
        list2finseq_uint32_closure_3_t cl11568;
        cl11568 = new_list2finseq_uint32_closure_3();
        ivar_2 = (list2finseq_uint32_funtype_2_t)cl11568;
...
extern list_adt__list_adt_t list2finseq_uint32__finseq2list_rec(list2finseq_uint32_record_1_t ivar_1, mpz_ptr_t ivar_3){
        ...
        uint8_t ivar_8;
        ivar_8 = (uint8_t)0;
        int64_t tmp11579 = mpz_cmp_ui(ivar_3, ivar_8);
        ivar_6 = (tmp11579 == 0);
        if (ivar_6){ 
...
extern list2finseq_uint32_funtype_5_t list2finseq_uint32__finseq2list(void){
        ...
        list2finseq_uint32_closure_6_t cl11590;
        cl11590 = new_list2finseq_uint32_closure_6();
        ivar_2 = (list2finseq_uint32_funtype_5_t)cl11590;
