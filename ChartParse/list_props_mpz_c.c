...
extern mpz_ptr_t list_props_mpz__length(list_adt__list_adt_t ivar_1){
        mpz_ptr_t  result;
        bool_t ivar_3;
        ivar_1->count++;
        ...
        if (ivar_3){ 
             ...
             mpz_ptr_t ivar_15;
             ivar_15 = (mpz_ptr_t)list_props_mpz__length((list_adt__list_adt_t)ivar_8);
             uint8_t ivar_16;
             ivar_16 = (uint8_t)1;
...
extern bool_t list_props_mpz__member(mpz_ptr_t ivar_1, list_adt__list_adt_t ivar_2){
        bool_t  result;
        bool_t ivar_4;
        ivar_2->count++;
        ...
        if (ivar_4){ 
             ...
             mpz_ptr_t ivar_8;
             ivar_2->count++;
             ivar_8 = (mpz_ptr_t)list_adt__list_adt_car((list_adt__list_adt_t)ivar_2);
             list_adt__list_adt_t ivar_9;
             ivar_9 = (list_adt__list_adt_t)list_adt__list_adt_cdr((list_adt__list_adt_t)ivar_2);
             bool_t ivar_16;
             int64_t tmp11451 = mpz_cmp(ivar_1, ivar_8);
             ivar_16 = (tmp11451 == 0);
             if (ivar_16){  
           ...
           result = (bool_t)list_props_mpz__member(ivar_1, (list_adt__list_adt_t)ivar_9);
};
};
...
extern mpz_ptr_t list_props_mpz__nth(list_adt__list_adt_t ivar_1, mpz_ptr_t ivar_2){
        mpz_ptr_t  result;
        bool_t ivar_6;
        uint8_t ivar_8;
        ivar_8 = (uint8_t)0;
        int64_t tmp11454 = mpz_cmp_ui(ivar_2, ivar_8);
        ivar_6 = (tmp11454 == 0);
        if (ivar_6){ 
             result = (mpz_ptr_t)list_adt__list_adt_car((list_adt__list_adt_t)ivar_1);
} else {
             ...
             result = (mpz_ptr_t)list_props_mpz__nth((list_adt__list_adt_t)ivar_22, ivar_23);
};
...
extern list_adt__list_adt_t list_props_mpz__append(list_adt__list_adt_t ivar_1, list_adt__list_adt_t ivar_2){
        ...
        if (ivar_4){ 
             ...
             mpz_ptr_t ivar_8;
             ivar_1->count++;
             ivar_8 = (mpz_ptr_t)list_adt__list_adt_car((list_adt__list_adt_t)ivar_1);
             list_adt__list_adt_t ivar_9;
             ivar_9 = (list_adt__list_adt_t)list_adt__list_adt_cdr((list_adt__list_adt_t)ivar_1);
             list_adt__T_t ivar_24;
             //copying to list_adt__T from mpz;
             ivar_24 = (list_adt__T_t)ivar_8;
             mpz_clear(ivar_8);
             list_adt__list_adt_t ivar_25;
             ivar_25 = (list_adt__list_adt_t)list_props_mpz__append((list_adt__list_adt_t)ivar_9, (list_adt__list_adt_t)ivar_2);
...
extern list_adt__list_adt_t list_props_mpz__reverse(list_adt__list_adt_t ivar_1){
        list_adt__list_adt_t  result;
        bool_t ivar_3;
        ivar_1->count++;
        ivar_3 = (bool_t)r_list_adt__nullp((list_adt__list_adt_t)ivar_1);
        if (ivar_3){ 
             ...
             mpz_ptr_t ivar_7;
             ivar_1->count++;
             ivar_7 = (mpz_ptr_t)list_adt__list_adt_car((list_adt__list_adt_t)ivar_1);
             list_adt__list_adt_t ivar_8;
             ivar_8 = (list_adt__list_adt_t)list_adt__list_adt_cdr((list_adt__list_adt_t)ivar_1);
             list_adt__list_adt_t ivar_26;
             ivar_26 = (list_adt__list_adt_t)list_props_mpz__reverse((list_adt__list_adt_t)ivar_8);
             ...
             result = (list_adt__list_adt_t)list_props_mpz__append((list_adt__list_adt_t)ivar_26, (list_adt__list_adt_t)ivar_27);
};
