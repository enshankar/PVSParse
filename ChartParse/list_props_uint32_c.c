...
extern mpz_ptr_t list_props_uint32__length(list_adt__list_adt_t ivar_1){
        ...
        if (ivar_3){ 
             ...
             mpz_ptr_t ivar_15;
             ivar_15 = (mpz_ptr_t)list_props_uint32__length((list_adt__list_adt_t)ivar_8);
             uint8_t ivar_16;
             ivar_16 = (uint8_t)1;
...
extern bool_t list_props_uint32__member(uint32_t ivar_1, list_adt__list_adt_t ivar_2){
        ...
        if (ivar_4){ 
             ...
             uint32_t ivar_8;
             ivar_2->count++;
             ivar_8 = (uint32_t)list_adt__list_adt_car((list_adt__list_adt_t)ivar_2);
             list_adt__list_adt_t ivar_9;
             ivar_9 = (list_adt__list_adt_t)list_adt__list_adt_cdr((list_adt__list_adt_t)ivar_2);
             bool_t ivar_16;
             ivar_16 = (ivar_1 == ivar_8);
             if (ivar_16){  
           release_list_adt__list_adt(ivar_9);
           result = (bool_t) true;
} else {
             
           result = (bool_t)list_props_uint32__member((uint32_t)ivar_1, (list_adt__list_adt_t)ivar_9);
};
};
...
extern uint32_t list_props_uint32__nth(list_adt__list_adt_t ivar_1, mpz_ptr_t ivar_2){
        ...
        uint8_t ivar_8;
        ivar_8 = (uint8_t)0;
        int64_t tmp11432 = mpz_cmp_ui(ivar_2, ivar_8);
        ivar_6 = (tmp11432 == 0);
        if (ivar_6){ 
             result = (uint32_t)list_adt__list_adt_car((list_adt__list_adt_t)ivar_1);
} else {
             ...
             result = (uint32_t)list_props_uint32__nth((list_adt__list_adt_t)ivar_22, ivar_23);
};
...
extern list_adt__list_adt_t list_props_uint32__append(list_adt__list_adt_t ivar_1, list_adt__list_adt_t ivar_2){
        ...
        if (ivar_4){ 
             ...
             uint32_t ivar_8;
             ivar_1->count++;
             ivar_8 = (uint32_t)list_adt__list_adt_car((list_adt__list_adt_t)ivar_1);
             list_adt__list_adt_t ivar_9;
             ...
             ivar_25 = (list_adt__list_adt_t)list_props_uint32__append((list_adt__list_adt_t)ivar_9, (list_adt__list_adt_t)ivar_2);
...
extern list_adt__list_adt_t list_props_uint32__reverse(list_adt__list_adt_t ivar_1){
        ...
        if (ivar_3){ 
             ...
             uint32_t ivar_7;
             ivar_1->count++;
             ivar_7 = (uint32_t)list_adt__list_adt_car((list_adt__list_adt_t)ivar_1);
             list_adt__list_adt_t ivar_8;
             ivar_8 = (list_adt__list_adt_t)list_adt__list_adt_cdr((list_adt__list_adt_t)ivar_1);
             list_adt__list_adt_t ivar_26;
             ivar_26 = (list_adt__list_adt_t)list_props_uint32__reverse((list_adt__list_adt_t)ivar_8);
             ...
             result = (list_adt__list_adt_t)list_props_uint32__append((list_adt__list_adt_t)ivar_26, (list_adt__list_adt_t)ivar_27);
};
