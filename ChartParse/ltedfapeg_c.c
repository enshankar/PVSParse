...
bool_t h_ltedfapeg_closure_59(ltedfapeg__ent_adt_t ivar_4, uint32_t ivar_1, uint32_t ivar_2){
        bool_t result;
        bool_t ivar_5;
        bool_t ivar_7;
        ivar_4->count++;
...
bool_t f_ltedfapeg_closure_67(struct ltedfapeg_closure_67_s * closure, ltedfapeg_record_64_t bvar){
        ...
        bool_t result = h_ltedfapeg_closure_67(bvar_1, bvar_2, closure->fvar_1, closure->fvar_2); 
...
bool_t m_ltedfapeg_closure_67(struct ltedfapeg_closure_67_s * closure, ltedfapeg__ent_adt_t bvar_1, ltedfapeg__ent_adt_t bvar_2){
        return h_ltedfapeg_closure_67(bvar_1, bvar_2, closure->fvar_1, closure->fvar_2);}

bool_t h_ltedfapeg_closure_67(ltedfapeg__ent_adt_t ivar_6, ltedfapeg__ent_adt_t ivar_7, ltedfapeg_array_62_t ivar_3, ltedfapeg__lang_spec_t ivar_2){
        bool_t result;
        /* p1 */ uint32_t ivar_8;
        ivar_6->count++;
...
mpz_ptr_t h_ltedfapeg_closure_70(uint32_t ivar_4, uint32_t ivar_1, ltedfapeg_array_69_t ivar_2){
        mpz_ptr_t result;
        bool_t ivar_5;
        uint8_t ivar_7;
        ivar_7 = (uint8_t)0;
...
void release_ltedfapeg_closure_70(ltedfapeg_funtype_68_t closure){
        ...
        x->count--;
        if (x->count <= 0){
         release_ltedfapeg_array_69(x->fvar_2);
        //printf("\nFreeing\n");
        safe_free(x);}}
...
bool_t h_ltedfapeg_closure_76(uint64_t ivar_5, uint32_t ivar_1, ltedfapeg_array_62_t ivar_2){
        bool_t result;
        uint64_t ivar_6;
        ivar_2->count++;
...
void release_ltedfapeg_closure_76(ltedfapeg_funtype_75_t closure){
        ...
        x->count--;
        if (x->count <= 0){
         release_ltedfapeg_array_62(x->fvar_2);
        //printf("\nFreeing\n");
        safe_free(x);}}
...
bool_t h_ltedfapeg_closure_77(ltedfapeg__ent_adt_t ivar_7, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_62_t ivar_4, uint32_t ivar_1, uint64_t ivar_3){
        bool_t result;
        bool_t ivar_8;
        uint8_t ivar_9;
        ivar_7->count++;
...
void release_ltedfapeg_closure_77(ltedfapeg_funtype_55_t closure){
        ...
        x->count--;
        if (x->count <= 0){
         release_ltedfapeg__lang_spec(x->fvar_1);
         release_ltedfapeg_array_62(x->fvar_2);
        //printf("\nFreeing\n");
        safe_free(x);}}
...
bool_t h_ltedfapeg_closure_78(ltedfapeg__ent_adt_t ivar_7, ltedfapeg__ent_adt_t ivar_8, ltedfapeg_array_62_t ivar_4, ltedfapeg__lang_spec_t ivar_2, uint32_t ivar_1, uint64_t ivar_3){
        bool_t result;
        bool_t ivar_9;
        uint8_t ivar_10;
        ivar_8->count++;
...
bool_t h_ltedfapeg_closure_79(ltedfapeg__ent_adt_t ivar_7, ltedfapeg_array_62_t ivar_4, ltedfapeg__lang_spec_t ivar_2, uint32_t ivar_1, uint64_t ivar_3){
        bool_t result;
        bool_t ivar_8;
        uint8_t ivar_9;
        ivar_7->count++;
        ...
        if (ivar_38){ 
           ...
           if (ivar_83){    
            ...
            if (ivar_97){     
             ...
             int64_t tmp41686 = mpz_cmp_ui(ivar_112, ivar_10);
             ivar_81 = (tmp41686 == 0);
} else {
           ...
           if (ivar_81){    
            ...
            if (ivar_152){     
             ...
             if (ivar_166){      
              ...
              int64_t tmp41687 = mpz_cmp_ui(ivar_196, ivar_10);
              result = (tmp41687 == 0);
} else {
...
bool_t h_ltedfapeg_closure_86(ltedfapeg_array_62_t ivar_5, uint32_t ivar_7, uint8_t ivar_8, ltedfapeg__lang_spec_t ivar_2, uint32_t ivar_1){
        bool_t result;
...
bool_t h_ltedfapeg_closure_89(ltedfapeg_array_62_t ivar_9, uint32_t ivar_11, uint8_t ivar_12, uint64_t ivar_13, mpz_ptr_t ivar_14, ltedfapeg_array_82_t ivar_3, uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2){
        ...
        if (ivar_32){ 
             ...
             uint8_t ivar_26;
             ivar_26 = (uint8_t)0;
             int64_t tmp41740 = mpz_cmp_ui(ivar_14, ivar_26);
             ivar_23 = (tmp41740 == 0);
             if (ivar_23){  
           uint8_t ivar_29;
           ivar_29 = (uint8_t)0;
           ...
           int64_t tmp41741 = mpz_cmp_ui(ivar_14, ivar_58);
           ivar_55 = (tmp41741 == 0);
           if (ivar_55){    
            uint8_t ivar_64;
            ivar_64 = (uint8_t)0;
           ...
           uint8_t ivar_79;
           ivar_79 = (uint8_t)1;
           int64_t tmp41742 = mpz_cmp_ui(ivar_14, ivar_79);
           ivar_76 = (tmp41742 == 0);
           if (ivar_76){    
            bool_t ivar_81;
            uint8_t ivar_83;
           ...
           if (ivar_282){    
            ...
            if (ivar_113){     
             ...
             if (ivar_127){      
              ...
              int64_t tmp41743 = mpz_cmp_ui(ivar_157, ivar_13);
              ivar_111 = (tmp41743 == 0);
} else {
            ...
            if (ivar_111){     
             ...
             if (ivar_212){      
              ...
              if (ivar_226){       
               ...
               int64_t tmp41744 = mpz_cmp_ui(ivar_241, ivar_13);
               result = (tmp41744 == 0);
} else {
...
bool_t h_ltedfapeg_closure_92(ltedfapeg_array_62_t ivar_6, uint32_t ivar_8, uint8_t ivar_9, ltedfapeg__ent_adt_t ivar_10, uint32_t ivar_1, ltedfapeg_array_82_t ivar_3, ltedfapeg__lang_spec_t ivar_2){
        bool_t result;
        bool_t ivar_37;
        ivar_10->count++;
...
bool_t h_ltedfapeg_closure_93(ltedfapeg_array_62_t ivar_6, uint32_t ivar_8, uint8_t ivar_9, ltedfapeg__ent_adt_t ivar_10, uint32_t ivar_1, ltedfapeg_array_82_t ivar_3, ltedfapeg__lang_spec_t ivar_2){
        bool_t result;
        bool_t ivar_37;
        ivar_10->count++;
        ivar_37 = (bool_t)r_ltedfapeg__failp((ltedfapeg__ent_adt_t)ivar_10);
...
ltedfapeg_funtype_94_t h_ltedfapeg_closure_98(uint32_t ivar_7, uint8_t ivar_8, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3, uint32_t ivar_1){
        ltedfapeg_funtype_94_t result;
        ltedfapeg_closure_99_t cl41896;
        cl41896 = new_ltedfapeg_closure_99();
        cl41896->fvar_1 = (uint32_t)ivar_7;
        cl41896->fvar_2 = (uint8_t)ivar_8;
        cl41896->fvar_3 = (uint32_t)ivar_1;
        cl41896->fvar_4 = (ltedfapeg_array_82_t)ivar_3;
        if (cl41896->fvar_4 != NULL) cl41896->fvar_4->count++;
        cl41896->fvar_5 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl41896->fvar_5 != NULL) cl41896->fvar_5->count++;
        result = (ltedfapeg_funtype_94_t)cl41896;
...
bool_t h_ltedfapeg_closure_99(ltedfapeg_array_62_t ivar_11, uint32_t ivar_7, uint8_t ivar_8, uint32_t ivar_1, ltedfapeg_array_82_t ivar_3, ltedfapeg__lang_spec_t ivar_2){
        bool_t result;
        bool_t ivar_13;
...
void release_ltedfapeg_closure_99(ltedfapeg_funtype_94_t closure){
        ...
        x->count--;
        if (x->count <= 0){
         release_ltedfapeg_array_82(x->fvar_4);
...
ordstruct_adt__ordstruct_adt_t h_ltedfapeg_closure_104(ltedfapeg_record_100_t ivar_8, uint32_t ivar_1){
        ...
        ltedfapeg_closure_105_t cl42081;
        cl42081 = new_ltedfapeg_closure_105();
        ivar_27 = (ltedfapeg_funtype_55_t)cl42081;
...
ltedfapeg_funtype_106_t f_ltedfapeg_closure_109(struct ltedfapeg_closure_109_s * closure, uint32_t bvar){
if (closure->htbl != NULL){
        ...
        return h_ltedfapeg_closure_109(bvar, closure->fvar_1, closure->fvar_2);};

return h_ltedfapeg_closure_109(bvar, closure->fvar_1, closure->fvar_2);}

ltedfapeg_funtype_106_t m_ltedfapeg_closure_109(struct ltedfapeg_closure_109_s * closure, uint32_t bvar){
        return h_ltedfapeg_closure_109(bvar, closure->fvar_1, closure->fvar_2);}

ltedfapeg_funtype_106_t h_ltedfapeg_closure_109(uint32_t ivar_20, uint32_t ivar_1, ltedfapeg_funtype_106_t ivar_5){
        ltedfapeg_funtype_106_t result;
...
ltedfapeg_closure_109_t new_ltedfapeg_closure_109(void){
        static struct ltedfapeg_funtype_108_ftbl_s ftbl = {.fptr = (ltedfapeg_funtype_106_t (*)(ltedfapeg_funtype_108_t, uint32_t))&f_ltedfapeg_closure_109, .mptr = (ltedfapeg_funtype_106_t (*)(ltedfapeg_funtype_108_t, uint32_t))&m_ltedfapeg_closure_109, .rptr =  (void (*)(ltedfapeg_funtype_108_t))&release_ltedfapeg_closure_109, .cptr = (ltedfapeg_funtype_108_t (*)(ltedfapeg_funtype_108_t))&copy_ltedfapeg_closure_109};
        ltedfapeg_closure_109_t tmp = (ltedfapeg_closure_109_t) safe_malloc(sizeof(struct ltedfapeg_closure_109_s));
        tmp->count = 1;
        tmp->ftbl = &ftbl;
        tmp->htbl = NULL;
        return tmp;}

void release_ltedfapeg_closure_109(ltedfapeg_funtype_108_t closure){
        ltedfapeg_closure_109_t x = (ltedfapeg_closure_109_t)closure;
        x->count--;
        if (x->count <= 0){
...
ltedfapeg_closure_109_t copy_ltedfapeg_closure_109(ltedfapeg_closure_109_t x){
        ltedfapeg_closure_109_t y = new_ltedfapeg_closure_109();
        y->ftbl = x->ftbl;
...
ltedfapeg__ent_adt_t ltedfapeg__fail(uint64_t ivar_2){
        ...
        uint8_t ivar_1;
        ivar_1 = (uint8_t)0;
        ltedfapeg__fail_t tmp41378 = new_ltedfapeg__fail();;
        result = (ltedfapeg__ent_adt_t)tmp41378;
        tmp41378->ltedfapeg__ent_adt_index = (uint8_t)ivar_1;
        tmp41378->dep = (uint64_t)ivar_2;
...
ltedfapeg__ent_adt_t ltedfapeg__pending(void){
        ...
        if (!defined){
                    uint8_t ivar_1;
        ivar_1 = (uint8_t)1;
        ltedfapeg__ent_adt_t tmp41379 = new_ltedfapeg__ent_adt();;
        result = (ltedfapeg__ent_adt_t)tmp41379;
        tmp41379->ltedfapeg__ent_adt_index = (uint8_t)ivar_1;
...
ltedfapeg__ent_adt_t ltedfapeg__loop(void){
        ...
        if (!defined){
                    uint8_t ivar_1;
        ivar_1 = (uint8_t)2;
        ltedfapeg__ent_adt_t tmp41380 = new_ltedfapeg__ent_adt();;
        result = (ltedfapeg__ent_adt_t)tmp41380;
        tmp41380->ltedfapeg__ent_adt_index = (uint8_t)ivar_1;
...
ltedfapeg__ent_adt_t ltedfapeg__good(uint64_t ivar_2, uint32_t ivar_3){
        ...
        uint8_t ivar_1;
        ivar_1 = (uint8_t)3;
        ltedfapeg__good_t tmp41381 = new_ltedfapeg__good();;
        result = (ltedfapeg__ent_adt_t)tmp41381;
        tmp41381->ltedfapeg__ent_adt_index = (uint8_t)ivar_1;
        tmp41381->dep = (uint64_t)ivar_2;
        tmp41381->span = (uint32_t)ivar_3;
...
ltedfapeg__ent_adt_t ltedfapeg__push(uint32_t ivar_2, uint8_t ivar_3){
        ...
        uint8_t ivar_1;
        ivar_1 = (uint8_t)4;
        ltedfapeg__push_t tmp41382 = new_ltedfapeg__push();;
        result = (ltedfapeg__ent_adt_t)tmp41382;
        tmp41382->ltedfapeg__ent_adt_index = (uint8_t)ivar_1;
        tmp41382->pos = (uint32_t)ivar_2;
        tmp41382->nt = (uint8_t)ivar_3;
...
ltedfapeg_funtype_5_t ltedfapeg__reduce_nat__1(ltedfapeg_funtype_6_t ivar_1, mpz_ptr_t ivar_3, mpz_ptr_t ivar_4, ltedfapeg_funtype_8_t ivar_5, ltedfapeg_funtype_10_t ivar_7){
        ...
        ltedfapeg_closure_11_t cl41397;
        cl41397 = new_ltedfapeg_closure_11();
        cl41397->fvar_1 = (ltedfapeg_funtype_8_t)ivar_5;
        if (cl41397->fvar_1 != NULL) cl41397->fvar_1->count++;
        cl41397->fvar_2 = (ltedfapeg_funtype_10_t)ivar_7;
        if (cl41397->fvar_2 != NULL) cl41397->fvar_2->count++;
        mpz_set(cl41397->fvar_3, ivar_4);
        mpz_set(cl41397->fvar_4, ivar_3);
        cl41397->fvar_5 = (ltedfapeg_funtype_6_t)ivar_1;
        if (cl41397->fvar_5 != NULL) cl41397->fvar_5->count++;
        release_ltedfapeg_funtype_8(ivar_5);
        release_ltedfapeg_funtype_10(ivar_7);
        release_ltedfapeg_funtype_6(ivar_1);
        result = (ltedfapeg_funtype_5_t)cl41397;
...
ltedfapeg_funtype_5_t ltedfapeg__REDUCE_nat__1(ltedfapeg_funtype_13_t ivar_1, ltedfapeg_funtype_5_t ivar_3, ltedfapeg_funtype_5_t ivar_5, ltedfapeg_funtype_15_t ivar_7, ltedfapeg_funtype_17_t ivar_9){
        ltedfapeg_funtype_5_t  result;
        ltedfapeg_closure_18_t cl41423;
        cl41423 = new_ltedfapeg_closure_18();
        cl41423->fvar_1 = (ltedfapeg_funtype_15_t)ivar_7;
        if (cl41423->fvar_1 != NULL) cl41423->fvar_1->count++;
        cl41423->fvar_2 = (ltedfapeg_funtype_17_t)ivar_9;
        if (cl41423->fvar_2 != NULL) cl41423->fvar_2->count++;
        cl41423->fvar_3 = (ltedfapeg_funtype_5_t)ivar_5;
        if (cl41423->fvar_3 != NULL) cl41423->fvar_3->count++;
        cl41423->fvar_4 = (ltedfapeg_funtype_5_t)ivar_3;
        if (cl41423->fvar_4 != NULL) cl41423->fvar_4->count++;
        cl41423->fvar_5 = (ltedfapeg_funtype_13_t)ivar_1;
        if (cl41423->fvar_5 != NULL) cl41423->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_5_t)cl41423;
...
ltedfapeg_funtype_19_t ltedfapeg__reduce_ordinal__1(ltedfapeg_funtype_20_t ivar_1, ordstruct_adt__ordstruct_adt_t ivar_3, ordstruct_adt__ordstruct_adt_t ivar_4, ltedfapeg_funtype_21_t ivar_5, ltedfapeg_funtype_22_t ivar_7){
        ...
        ltedfapeg_closure_23_t cl41437;
        cl41437 = new_ltedfapeg_closure_23();
        cl41437->fvar_1 = (ltedfapeg_funtype_21_t)ivar_5;
        if (cl41437->fvar_1 != NULL) cl41437->fvar_1->count++;
        cl41437->fvar_2 = (ltedfapeg_funtype_22_t)ivar_7;
        if (cl41437->fvar_2 != NULL) cl41437->fvar_2->count++;
        cl41437->fvar_3 = (ordstruct_adt__ordstruct_adt_t)ivar_4;
        if (cl41437->fvar_3 != NULL) cl41437->fvar_3->count++;
        cl41437->fvar_4 = (ordstruct_adt__ordstruct_adt_t)ivar_3;
        if (cl41437->fvar_4 != NULL) cl41437->fvar_4->count++;
        cl41437->fvar_5 = (ltedfapeg_funtype_20_t)ivar_1;
        if (cl41437->fvar_5 != NULL) cl41437->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_19_t)cl41437;
...
ltedfapeg_funtype_19_t ltedfapeg__REDUCE_ordinal__1(ltedfapeg_funtype_24_t ivar_1, ltedfapeg_funtype_19_t ivar_3, ltedfapeg_funtype_19_t ivar_5, ltedfapeg_funtype_25_t ivar_7, ltedfapeg_funtype_26_t ivar_9){
        ltedfapeg_funtype_19_t  result;
        ltedfapeg_closure_27_t cl41463;
        cl41463 = new_ltedfapeg_closure_27();
        cl41463->fvar_1 = (ltedfapeg_funtype_25_t)ivar_7;
        if (cl41463->fvar_1 != NULL) cl41463->fvar_1->count++;
        cl41463->fvar_2 = (ltedfapeg_funtype_26_t)ivar_9;
        if (cl41463->fvar_2 != NULL) cl41463->fvar_2->count++;
        cl41463->fvar_3 = (ltedfapeg_funtype_19_t)ivar_5;
        if (cl41463->fvar_3 != NULL) cl41463->fvar_3->count++;
        cl41463->fvar_4 = (ltedfapeg_funtype_19_t)ivar_3;
        if (cl41463->fvar_4 != NULL) cl41463->fvar_4->count++;
        cl41463->fvar_5 = (ltedfapeg_funtype_24_t)ivar_1;
        if (cl41463->fvar_5 != NULL) cl41463->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_19_t)cl41463;
...
ltedfapeg__prepeg_adt_t ltedfapeg__epsilon(void){
        ...
        if (!defined){
                    uint8_t ivar_1;
        ivar_1 = (uint8_t)0;
        ltedfapeg__prepeg_adt_t tmp41481 = new_ltedfapeg__prepeg_adt();;
        result = (ltedfapeg__prepeg_adt_t)tmp41481;
        tmp41481->ltedfapeg__prepeg_adt_index = (uint8_t)ivar_1;
...
ltedfapeg__prepeg_adt_t ltedfapeg__failure(void){
        ...
        if (!defined){
                    uint8_t ivar_1;
        ivar_1 = (uint8_t)1;
        ltedfapeg__prepeg_adt_t tmp41482 = new_ltedfapeg__prepeg_adt();;
        result = (ltedfapeg__prepeg_adt_t)tmp41482;
        tmp41482->ltedfapeg__prepeg_adt_index = (uint8_t)ivar_1;
...
ltedfapeg__prepeg_adt_t ltedfapeg__any(dfa__dfa_t ivar_2){
        ...
        uint8_t ivar_1;
        ivar_1 = (uint8_t)2;
        ltedfapeg__any_t tmp41483 = new_ltedfapeg__any();;
        result = (ltedfapeg__prepeg_adt_t)tmp41483;
        tmp41483->ltedfapeg__prepeg_adt_index = (uint8_t)ivar_1;
        tmp41483->dfa = (dfa__dfa_t)ivar_2;
...
ltedfapeg__prepeg_adt_t ltedfapeg__terminal(uint8_t ivar_2){
        ...
        uint8_t ivar_1;
        ivar_1 = (uint8_t)3;
        ltedfapeg__terminal_t tmp41484 = new_ltedfapeg__terminal();;
        result = (ltedfapeg__prepeg_adt_t)tmp41484;
        tmp41484->ltedfapeg__prepeg_adt_index = (uint8_t)ivar_1;
        tmp41484->a = (uint8_t)ivar_2;
...
ltedfapeg__prepeg_adt_t ltedfapeg__lte(uint8_t ivar_2, uint8_t ivar_3, uint8_t ivar_4){
        ...
        uint8_t ivar_1;
        ivar_1 = (uint8_t)4;
        ltedfapeg__lte_t tmp41485 = new_ltedfapeg__lte();;
        result = (ltedfapeg__prepeg_adt_t)tmp41485;
        tmp41485->ltedfapeg__prepeg_adt_index = (uint8_t)ivar_1;
        tmp41485->fst = (uint8_t)ivar_2;
        tmp41485->lthen = (uint8_t)ivar_3;
        tmp41485->lelse = (uint8_t)ivar_4;
...
ltedfapeg_funtype_33_t ltedfapeg__reduce_nat__2(mpz_ptr_t ivar_1, mpz_ptr_t ivar_2, ltedfapeg_funtype_34_t ivar_3, ltedfapeg_funtype_35_t ivar_5, ltedfapeg_funtype_37_t ivar_7){
        ...
        ltedfapeg_closure_38_t cl41497;
        cl41497 = new_ltedfapeg_closure_38();
        cl41497->fvar_1 = (ltedfapeg_funtype_35_t)ivar_5;
        if (cl41497->fvar_1 != NULL) cl41497->fvar_1->count++;
        cl41497->fvar_2 = (ltedfapeg_funtype_37_t)ivar_7;
        if (cl41497->fvar_2 != NULL) cl41497->fvar_2->count++;
        cl41497->fvar_3 = (ltedfapeg_funtype_34_t)ivar_3;
        if (cl41497->fvar_3 != NULL) cl41497->fvar_3->count++;
        mpz_set(cl41497->fvar_4, ivar_2);
        mpz_set(cl41497->fvar_5, ivar_1);
        release_ltedfapeg_funtype_35(ivar_5);
        release_ltedfapeg_funtype_37(ivar_7);
        release_ltedfapeg_funtype_34(ivar_3);
        result = (ltedfapeg_funtype_33_t)cl41497;
...
ltedfapeg_funtype_33_t ltedfapeg__REDUCE_nat__2(ltedfapeg_funtype_33_t ivar_1, ltedfapeg_funtype_33_t ivar_3, ltedfapeg_funtype_40_t ivar_5, ltedfapeg_funtype_42_t ivar_7, ltedfapeg_funtype_44_t ivar_9){
        ltedfapeg_funtype_33_t  result;
        ltedfapeg_closure_45_t cl41523;
        cl41523 = new_ltedfapeg_closure_45();
        cl41523->fvar_1 = (ltedfapeg_funtype_42_t)ivar_7;
        if (cl41523->fvar_1 != NULL) cl41523->fvar_1->count++;
        cl41523->fvar_2 = (ltedfapeg_funtype_44_t)ivar_9;
        if (cl41523->fvar_2 != NULL) cl41523->fvar_2->count++;
        cl41523->fvar_3 = (ltedfapeg_funtype_40_t)ivar_5;
        if (cl41523->fvar_3 != NULL) cl41523->fvar_3->count++;
        cl41523->fvar_4 = (ltedfapeg_funtype_33_t)ivar_3;
        if (cl41523->fvar_4 != NULL) cl41523->fvar_4->count++;
        cl41523->fvar_5 = (ltedfapeg_funtype_33_t)ivar_1;
        if (cl41523->fvar_5 != NULL) cl41523->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_33_t)cl41523;
...
ltedfapeg_funtype_46_t ltedfapeg__reduce_ordinal__2(ordstruct_adt__ordstruct_adt_t ivar_1, ordstruct_adt__ordstruct_adt_t ivar_2, ltedfapeg_funtype_47_t ivar_3, ltedfapeg_funtype_48_t ivar_5, ltedfapeg_funtype_49_t ivar_7){
        ...
        ltedfapeg_closure_50_t cl41534;
        cl41534 = new_ltedfapeg_closure_50();
        cl41534->fvar_1 = (ltedfapeg_funtype_48_t)ivar_5;
        if (cl41534->fvar_1 != NULL) cl41534->fvar_1->count++;
        cl41534->fvar_2 = (ltedfapeg_funtype_49_t)ivar_7;
        if (cl41534->fvar_2 != NULL) cl41534->fvar_2->count++;
        cl41534->fvar_3 = (ltedfapeg_funtype_47_t)ivar_3;
        if (cl41534->fvar_3 != NULL) cl41534->fvar_3->count++;
        cl41534->fvar_4 = (ordstruct_adt__ordstruct_adt_t)ivar_2;
        if (cl41534->fvar_4 != NULL) cl41534->fvar_4->count++;
        cl41534->fvar_5 = (ordstruct_adt__ordstruct_adt_t)ivar_1;
        if (cl41534->fvar_5 != NULL) cl41534->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_46_t)cl41534;
...
ltedfapeg_funtype_46_t ltedfapeg__REDUCE_ordinal__2(ltedfapeg_funtype_46_t ivar_1, ltedfapeg_funtype_46_t ivar_3, ltedfapeg_funtype_51_t ivar_5, ltedfapeg_funtype_52_t ivar_7, ltedfapeg_funtype_53_t ivar_9){
        ltedfapeg_funtype_46_t  result;
        ltedfapeg_closure_54_t cl41560;
        cl41560 = new_ltedfapeg_closure_54();
        cl41560->fvar_1 = (ltedfapeg_funtype_52_t)ivar_7;
        if (cl41560->fvar_1 != NULL) cl41560->fvar_1->count++;
        cl41560->fvar_2 = (ltedfapeg_funtype_53_t)ivar_9;
        if (cl41560->fvar_2 != NULL) cl41560->fvar_2->count++;
        cl41560->fvar_3 = (ltedfapeg_funtype_51_t)ivar_5;
        if (cl41560->fvar_3 != NULL) cl41560->fvar_3->count++;
        cl41560->fvar_4 = (ltedfapeg_funtype_46_t)ivar_3;
        if (cl41560->fvar_4 != NULL) cl41560->fvar_4->count++;
        cl41560->fvar_5 = (ltedfapeg_funtype_46_t)ivar_1;
        if (cl41560->fvar_5 != NULL) cl41560->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_46_t)cl41560;
...
ltedfapeg_funtype_55_t ltedfapeg__good_good_entryp(uint32_t ivar_1, uint32_t ivar_2){
        ...
        ltedfapeg_closure_56_t cl41562;
        cl41562 = new_ltedfapeg_closure_56();
        cl41562->fvar_1 = (uint32_t)ivar_2;
        cl41562->fvar_2 = (uint32_t)ivar_1;
        result = (ltedfapeg_funtype_55_t)cl41562;
...
ltedfapeg_funtype_55_t ltedfapeg__good_push_entryp(uint32_t ivar_1){
        ltedfapeg_funtype_55_t  result;
        ltedfapeg_closure_57_t cl41563;
        cl41563 = new_ltedfapeg_closure_57();
        cl41563->fvar_1 = (uint32_t)ivar_1;
        result = (ltedfapeg_funtype_55_t)cl41563;
...
ltedfapeg_funtype_55_t ltedfapeg__fine_push_entryp(uint32_t ivar_1){
        ltedfapeg_funtype_55_t  result;
        ltedfapeg_closure_58_t cl41564;
        cl41564 = new_ltedfapeg_closure_58();
        cl41564->fvar_1 = (uint32_t)ivar_1;
        result = (ltedfapeg_funtype_55_t)cl41564;
...
ltedfapeg_funtype_55_t ltedfapeg__nice_entryp(uint32_t ivar_1, uint32_t ivar_2){
        ltedfapeg_funtype_55_t  result;
        ltedfapeg_closure_59_t cl41567;
        cl41567 = new_ltedfapeg_closure_59();
        cl41567->fvar_1 = (uint32_t)ivar_1;
        cl41567->fvar_2 = (uint32_t)ivar_2;
        result = (ltedfapeg_funtype_55_t)cl41567;
...
ltedfapeg_funtype_60_t ltedfapeg__instack(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2){
        ...
        ltedfapeg_closure_63_t cl41577;
        cl41577 = new_ltedfapeg_closure_63();
        cl41577->fvar_1 = (ltedfapeg_array_62_t)ivar_2;
        if (cl41577->fvar_1 != NULL) cl41577->fvar_1->count++;
        cl41577->fvar_2 = (uint32_t)ivar_1;
        release_ltedfapeg_array_62(ivar_2);
        result = (ltedfapeg_funtype_60_t)cl41577;
...
ltedfapeg_funtype_65_t ltedfapeg__successor(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_62_t ivar_3){
        ...
        ltedfapeg_closure_67_t cl41587;
        cl41587 = new_ltedfapeg_closure_67();
        cl41587->fvar_1 = (ltedfapeg_array_62_t)ivar_3;
        if (cl41587->fvar_1 != NULL) cl41587->fvar_1->count++;
        cl41587->fvar_2 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl41587->fvar_2 != NULL) cl41587->fvar_2->count++;
        release_ltedfapeg_array_62(ivar_3);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_65_t)cl41587;
...
ltedfapeg_funtype_68_t ltedfapeg__sigma(uint32_t ivar_1, ltedfapeg_array_69_t ivar_2){
        ...
        ltedfapeg_closure_70_t cl41596;
        cl41596 = new_ltedfapeg_closure_70();
        cl41596->fvar_1 = (uint32_t)ivar_1;
        cl41596->fvar_2 = (ltedfapeg_array_69_t)ivar_2;
        if (cl41596->fvar_2 != NULL) cl41596->fvar_2->count++;
        release_ltedfapeg_array_69(ivar_2);
        result = (ltedfapeg_funtype_68_t)cl41596;
...
uint64_t ltedfapeg__scafcount(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2, ltedfapeg_funtype_55_t ivar_4, uint32_t ivar_6){
        ...
        size41607 = (uint32_t)ivar_1;
        size41607 += 1;
        ivar_46 = new_ltedfapeg_array_69(size41607);
        uint32_t ivar_14;
        for (uint32_t index41606 = 0; index41606 < size41607; index41606++){
             ivar_14 = (uint32_t)index41606;
             ...
             ivar_41->count++;
             mpz_mk_set_ui(ivar_46->elems[ivar_14], ivar_23->ftbl->fptr(ivar_23, ivar_41));
             ivar_23->ftbl->rptr(ivar_23);
        };
...
uint64_t ltedfapeg__pushcount(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2){
        uint64_t  result;
        ltedfapeg_funtype_55_t ivar_15;
        ltedfapeg_closure_73_t cl41611;
        cl41611 = new_ltedfapeg_closure_73();
        ivar_15 = (ltedfapeg_funtype_55_t)cl41611;
...
uint64_t ltedfapeg__gfcount(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2){
        ...
        ltedfapeg_closure_74_t cl41615;
        cl41615 = new_ltedfapeg_closure_74();
        ivar_16 = (ltedfapeg_funtype_55_t)cl41615;
...
ltedfapeg_funtype_75_t ltedfapeg__good_depthp(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2){
        ...
        ltedfapeg_closure_76_t cl41618;
        cl41618 = new_ltedfapeg_closure_76();
        cl41618->fvar_1 = (uint32_t)ivar_1;
        cl41618->fvar_2 = (ltedfapeg_array_62_t)ivar_2;
        if (cl41618->fvar_2 != NULL) cl41618->fvar_2->count++;
        release_ltedfapeg_array_62(ivar_2);
        result = (ltedfapeg_funtype_75_t)cl41618;
...
ltedfapeg_funtype_55_t ltedfapeg__good_stackp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, uint64_t ivar_3, ltedfapeg_array_62_t ivar_4){
        ltedfapeg_funtype_55_t  result;
        ltedfapeg_closure_77_t cl41627;
        cl41627 = new_ltedfapeg_closure_77();
        cl41627->fvar_1 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl41627->fvar_1 != NULL) cl41627->fvar_1->count++;
        cl41627->fvar_2 = (ltedfapeg_array_62_t)ivar_4;
        if (cl41627->fvar_2 != NULL) cl41627->fvar_2->count++;
        cl41627->fvar_3 = (uint32_t)ivar_1;
        cl41627->fvar_4 = (uint64_t)ivar_3;
        release_ltedfapeg_array_62(ivar_4);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_55_t)cl41627;
...
ltedfapeg_funtype_65_t ltedfapeg__mem_stackp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, uint64_t ivar_3, ltedfapeg_array_62_t ivar_4){
        ltedfapeg_funtype_65_t  result;
        ltedfapeg_closure_78_t cl41639;
        cl41639 = new_ltedfapeg_closure_78();
        cl41639->fvar_1 = (ltedfapeg_array_62_t)ivar_4;
        if (cl41639->fvar_1 != NULL) cl41639->fvar_1->count++;
        cl41639->fvar_2 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl41639->fvar_2 != NULL) cl41639->fvar_2->count++;
        cl41639->fvar_3 = (uint32_t)ivar_1;
        cl41639->fvar_4 = (uint64_t)ivar_3;
        release_ltedfapeg_array_62(ivar_4);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_65_t)cl41639;
...
ltedfapeg_funtype_55_t ltedfapeg__fine_stackp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, uint64_t ivar_3, ltedfapeg_array_62_t ivar_4){
        ltedfapeg_funtype_55_t  result;
        ltedfapeg_closure_79_t cl41649;
        cl41649 = new_ltedfapeg_closure_79();
        cl41649->fvar_1 = (ltedfapeg_array_62_t)ivar_4;
        if (cl41649->fvar_1 != NULL) cl41649->fvar_1->count++;
        cl41649->fvar_2 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl41649->fvar_2 != NULL) cl41649->fvar_2->count++;
        cl41649->fvar_3 = (uint32_t)ivar_1;
        cl41649->fvar_4 = (uint64_t)ivar_3;
        release_ltedfapeg_array_62(ivar_4);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_55_t)cl41649;
...
ltedfapeg_funtype_81_t ltedfapeg__good_failp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ...
        ltedfapeg_closure_83_t cl41688;
        cl41688 = new_ltedfapeg_closure_83();
        cl41688->fvar_1 = (ltedfapeg_array_82_t)ivar_3;
        if (cl41688->fvar_1 != NULL) cl41688->fvar_1->count++;
        cl41688->fvar_2 = (uint32_t)ivar_1;
        cl41688->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl41688->fvar_3 != NULL) cl41688->fvar_3->count++;
        release_ltedfapeg_array_82(ivar_3);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_81_t)cl41688;
...
ltedfapeg_funtype_85_t ltedfapeg__good_loopp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2){
        ...
        ltedfapeg_closure_86_t cl41706;
        cl41706 = new_ltedfapeg_closure_86();
        cl41706->fvar_1 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl41706->fvar_1 != NULL) cl41706->fvar_1->count++;
        cl41706->fvar_2 = (uint32_t)ivar_1;
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_85_t)cl41706;
...
ltedfapeg_funtype_88_t ltedfapeg__good_goodp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ...
        ltedfapeg_closure_89_t cl41745;
        cl41745 = new_ltedfapeg_closure_89();
        cl41745->fvar_1 = (ltedfapeg_array_82_t)ivar_3;
        if (cl41745->fvar_1 != NULL) cl41745->fvar_1->count++;
        cl41745->fvar_2 = (uint32_t)ivar_1;
        cl41745->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl41745->fvar_3 != NULL) cl41745->fvar_3->count++;
        release_ltedfapeg_array_82(ivar_3);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_88_t)cl41745;
...
ltedfapeg_funtype_91_t ltedfapeg__good_entryp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ...
        ltedfapeg_closure_92_t cl41794;
        cl41794 = new_ltedfapeg_closure_92();
        cl41794->fvar_1 = (uint32_t)ivar_1;
        cl41794->fvar_2 = (ltedfapeg_array_82_t)ivar_3;
        if (cl41794->fvar_2 != NULL) cl41794->fvar_2->count++;
        cl41794->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl41794->fvar_3 != NULL) cl41794->fvar_3->count++;
        release_ltedfapeg__lang_spec(ivar_2);
        release_ltedfapeg_array_82(ivar_3);
        result = (ltedfapeg_funtype_91_t)cl41794;
...
ltedfapeg_funtype_91_t ltedfapeg__fine_entryp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ltedfapeg_funtype_91_t  result;
        ltedfapeg_closure_93_t cl41844;
        cl41844 = new_ltedfapeg_closure_93();
        cl41844->fvar_1 = (uint32_t)ivar_1;
        cl41844->fvar_2 = (ltedfapeg_array_82_t)ivar_3;
        if (cl41844->fvar_2 != NULL) cl41844->fvar_2->count++;
        cl41844->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl41844->fvar_3 != NULL) cl41844->fvar_3->count++;
        release_ltedfapeg__lang_spec(ivar_2);
        release_ltedfapeg_array_82(ivar_3);
        result = (ltedfapeg_funtype_91_t)cl41844;
...
ltedfapeg_funtype_94_t ltedfapeg__good_tscaffoldp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ltedfapeg_funtype_94_t  result;
        ltedfapeg_closure_95_t cl41866;
        cl41866 = new_ltedfapeg_closure_95();
        cl41866->fvar_1 = (uint32_t)ivar_1;
        result = (ltedfapeg_funtype_94_t)cl41866;
...
ltedfapeg_funtype_60_t ltedfapeg__good_rootp(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2){
        ltedfapeg_funtype_60_t  result;
        ltedfapeg_closure_96_t cl41875;
        cl41875 = new_ltedfapeg_closure_96();
        cl41875->fvar_1 = (ltedfapeg_array_62_t)ivar_2;
        if (cl41875->fvar_1 != NULL) cl41875->fvar_1->count++;
        cl41875->fvar_2 = (uint32_t)ivar_1;
        release_ltedfapeg_array_62(ivar_2);
        result = (ltedfapeg_funtype_60_t)cl41875;
...
ltedfapeg_funtype_97_t ltedfapeg__fine_scaffoldp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ...
        ltedfapeg_closure_98_t cl41897;
        cl41897 = new_ltedfapeg_closure_98();
        cl41897->fvar_1 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl41897->fvar_1 != NULL) cl41897->fvar_1->count++;
        cl41897->fvar_2 = (ltedfapeg_array_82_t)ivar_3;
        if (cl41897->fvar_2 != NULL) cl41897->fvar_2->count++;
        cl41897->fvar_3 = (uint32_t)ivar_1;
        release_ltedfapeg_array_82(ivar_3);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_97_t)cl41897;
...
ltedfapeg_funtype_101_t ltedfapeg__step(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3, uint32_t ivar_4, uint8_t ivar_5){
        ...
        ltedfapeg_closure_102_t cl42055;
        cl42055 = new_ltedfapeg_closure_102();
        cl42055->fvar_1 = (uint32_t)ivar_1;
        cl42055->fvar_2 = (ltedfapeg_array_82_t)ivar_3;
        if (cl42055->fvar_2 != NULL) cl42055->fvar_2->count++;
        cl42055->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl42055->fvar_3 != NULL) cl42055->fvar_3->count++;
        release_ltedfapeg_array_82(ivar_3);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_101_t)cl42055;
...
ltedfapeg_funtype_103_t ltedfapeg__size(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3, uint32_t ivar_4, uint8_t ivar_5){
        ...
        ltedfapeg_closure_104_t cl42082;
        cl42082 = new_ltedfapeg_closure_104();
        cl42082->fvar_1 = (uint32_t)ivar_1;
        result = (ltedfapeg_funtype_103_t)cl42082;
...
ltedfapeg__ent_adt_t ltedfapeg__doparse(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3, uint8_t ivar_4){
        ...
        ltedfapeg_closure_107_t cl42195;
        cl42195 = new_ltedfapeg_closure_107();
        ivar_5 = (ltedfapeg_funtype_106_t)cl42195;
        /* St */ ltedfapeg_record_100_t ivar_10;
        ltedfapeg_array_62_t ivar_43;
        ...
        uint8_t ivar_28;
        ivar_28 = (uint8_t)ltedfapeg__num_non_terminals();
        ivar_23 = (ltedfapeg__ent_adt_t)ltedfapeg__push((uint32_t)ivar_27, (uint8_t)ivar_28);
        ltedfapeg_funtype_108_t ivar_31;
        ltedfapeg_closure_109_t cl42196;
        cl42196 = new_ltedfapeg_closure_109();
        cl42196->fvar_1 = (uint32_t)ivar_1;
        cl42196->fvar_2 = (ltedfapeg_funtype_106_t)ivar_5;
        if (cl42196->fvar_2 != NULL) cl42196->fvar_2->count++;
        release_ltedfapeg_funtype_106(ivar_5);
        ivar_31 = (ltedfapeg_funtype_108_t)cl42196;
        uint32_t ivar_38;
        ivar_38 = (uint32_t)0;
        ltedfapeg_funtype_106_t ivar_32;
        ivar_32 = (ltedfapeg_funtype_106_t)ivar_31->ftbl->fptr(ivar_31, ivar_38);
        ltedfapeg_funtype_108_t ivar_39;
        ltedfapeg_funtype_106_t ivar_41;
        ivar_41 = NULL;
        ivar_39 = (ltedfapeg_funtype_108_t)update_ltedfapeg_funtype_108(ivar_31, ivar_38, ivar_41);
        if (ivar_41 != NULL) ivar_41->count--;
        ltedfapeg_funtype_106_t ivar_40;
        ltedfapeg_funtype_106_t ivar_35;
        ltedfapeg__ent_adt_t ivar_37;
        ivar_37 = NULL;
        ivar_35 = (ltedfapeg_funtype_106_t)update_ltedfapeg_funtype_106(ivar_32, ivar_4, ivar_37);
        if (ivar_37 != NULL) ivar_37->count--;
        ivar_40 = (ltedfapeg_funtype_106_t)update_ltedfapeg_funtype_106(ivar_35, ivar_4, ivar_23);
        if (ivar_23 != NULL) ivar_23->count--;
        ivar_43 = (ltedfapeg_array_62_t)update_ltedfapeg_funtype_108(ivar_39, ivar_38, ivar_40);
        if (ivar_40 != NULL) ivar_40->count--;
        uint8_t ivar_83;
        ivar_83 = (uint8_t)1;
        uint64_t ivar_45;
        //copying to uint64 from uint8;
        ivar_45 = (uint64_t)ivar_83;
        ltedfapeg__ent_adt_t ivar_53;
        uint8_t ivar_52;
        ivar_52 = (uint8_t)0;
        uint32_t ivar_49;
        ...
        bool_t ivar_54;
        ivar_54 = (bool_t) false;
        ltedfapeg_record_100_t tmp42197 = new_ltedfapeg_record_100();;
        ivar_10 = (ltedfapeg_record_100_t)tmp42197;
        tmp42197->scaf = (ltedfapeg_array_62_t)ivar_43;
        tmp42197->depth = (uint64_t)ivar_45;
        tmp42197->stack = (ltedfapeg__ent_adt_t)ivar_53;
        tmp42197->lflag = (bool_t)ivar_54;
        ltedfapeg_array_61_t ivar_57;
        ltedfapeg_array_62_t ivar_61;
        ltedfapeg_record_100_t ivar_79;
        uint8_t ivar_78;
        ivar_78 = (uint8_t)0;
        uint32_t ivar_73;
        //copying to uint32 from uint8;
        ivar_73 = (uint32_t)ivar_78;
        ivar_79 = (ltedfapeg_record_100_t)ltedfapeg__parse((uint32_t)ivar_1, (ltedfapeg__lang_spec_t)ivar_2, (ltedfapeg_array_82_t)ivar_3, (uint32_t)ivar_73, (uint8_t)ivar_4, (ltedfapeg_record_100_t)ivar_10);
        ivar_61 = (ltedfapeg_array_62_t)ivar_79->scaf;
        ivar_61->count++;
        release_ltedfapeg_record_100(ivar_79);
        uint32_t ivar_81;
        ivar_81 = (uint32_t)0;
        ivar_57 = (ltedfapeg_array_61_t)ivar_61->elems[ivar_81];
        ivar_57->count++;
        release_ltedfapeg_array_62(ivar_61);
        result = (ltedfapeg__ent_adt_t)ivar_57->elems[ivar_4];
        result->count++;
        release_ltedfapeg_array_61(ivar_57);
