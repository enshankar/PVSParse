...
extern uint32_t lookup_bv_funtype_0(bv_funtype_0_htbl_t htbl, mpz_ptr_t i, uint32_t ihash);

extern bv_funtype_0_t dupdate_bv_funtype_0(bv_funtype_0_t a, mpz_ptr_t i, bool_t v, mpz_ptr_t bv__N);
...
extern char* json_bv_funtype_0(bv_funtype_0_t x, mpz_ptr_t bv__N);
...
extern bool_t h_bv_closure_1(mpz_ptr_t ivar_3, mpz_ptr_t bv__N, bool_t ivar_1);
