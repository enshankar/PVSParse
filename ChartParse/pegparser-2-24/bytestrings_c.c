...
bytestrings__bytestring_t bytestrings__null(void){
        ...
        size2318 = (uint32_t)ivar_1;
        size2318 += 0;
        ivar_6 = new_bytestrings_array_0(size2318);
        uint8_t ivar_5;
        for (uint32_t index2317 = 0; index2317 < size2318; index2317++){
             ivar_5 = (uint8_t)index2317;
             ivar_6->elems[index2317] = (uint8_t)0;
        };
        bytestrings__bytestring_t tmp2319 = new_bytestrings__bytestring();;
        result = (bytestrings__bytestring_t)tmp2319;
        tmp2319->length = (uint32_t)ivar_1;
        tmp2319->seq = (bytestrings_array_0_t)ivar_6;
...
bytestrings__bytestring_t bytestrings__unit(uint8_t ivar_1){
        ...
        uint32_t size2325;
        //copying to uint32 from uint32;
        size2325 = (uint32_t)ivar_2;
        size2325 += 0;
        ivar_6 = new_bytestrings_array_0(size2325);
        uint8_t ivar_5;
        for (uint32_t index2324 = 0; index2324 < size2325; index2324++){
             ivar_5 = (uint8_t)index2324;
             //copying to uint8 from uint8;
             ivar_6->elems[index2324] = (uint8_t)ivar_1;
        };
        bytestrings__bytestring_t tmp2326 = new_bytestrings__bytestring();;
        result = (bytestrings__bytestring_t)tmp2326;
        tmp2326->length = (uint32_t)ivar_2;
        tmp2326->seq = (bytestrings_array_0_t)ivar_6;
...
bytestrings__bytestring_t bytestrings__mk_bytestring(strings__string_t ivar_1){
        ...
        uint32_t size2336;
        //copying to uint32 from uint32;
        size2336 = (uint32_t)ivar_3;
        size2336 += 0;
        ivar_18 = new_bytestrings_array_0(size2336);
        for (uint32_t index2335 = 0; index2335 < size2336; index2335++){
             mpz_t ivar_8;
             mpz_init(ivar_8);
             mpz_set_ui(ivar_8, index2335);
             uint32_t ivar_10;
             ivar_1->count++;
             ivar_10 = (uint32_t)gen_strings__get((strings__string_t)ivar_1, (mpz_ptr_t)ivar_8);
             ivar_18->elems[index2335] = (uint32_t) ivar_10;
        };
        release_strings__string(ivar_1);
        bytestrings__bytestring_t tmp2337 = new_bytestrings__bytestring();;
        result = (bytestrings__bytestring_t)tmp2337;
        tmp2337->length = (uint32_t)ivar_3;
        tmp2337->seq = (bytestrings_array_0_t)ivar_18;
...
bytestrings__bytestring_t bytestrings__doubleplus(bytestrings__bytestring_t ivar_1, bytestrings__bytestring_t ivar_2){
        ...
        if (ivar_3){ 
           ...
           uint32_t size2348;
           //copying to uint32 from uint32;
           size2348 = (uint32_t)ivar_13;
           size2348 += 0;
           ivar_46 = new_bytestrings_array_0(size2348);
           uint32_t ivar_22;
           for (uint32_t index2347 = 0; index2347 < size2348; index2347++){
           ivar_22 = (uint32_t)index2347;
           bool_t ivar_23;
           uint32_t ivar_25;
           ...
           if (ivar_23){    
            ivar_1->count++;
            ivar_46->elems[index2347] = (uint8_t)bytestrings__get((bytestrings__bytestring_t)ivar_1, (uint32_t)ivar_22);
} else {
            ...
            ivar_2->count++;
            ivar_46->elems[index2347] = (uint8_t)bytestrings__get((bytestrings__bytestring_t)ivar_2, (uint32_t)ivar_42);
};
           };
           release_bytestrings__bytestring(ivar_2);
           release_bytestrings__bytestring(ivar_1);
           bytestrings__bytestring_t tmp2349 = new_bytestrings__bytestring();;
           result = (bytestrings__bytestring_t)tmp2349;
           tmp2349->length = (uint32_t)ivar_13;
           tmp2349->seq = (bytestrings_array_0_t)ivar_46;
};
};
...
bytestrings__bytestring_t bytestrings__prefix(bytestrings__bytestring_t ivar_1, uint32_t ivar_2){
        ...
        if (ivar_4){ 
             ...
             uint32_t size2389;
             //copying to uint32 from uint32;
             size2389 = (uint32_t)ivar_2;
             size2389 += 0;
             ivar_22 = new_bytestrings_array_0(size2389);
             uint32_t ivar_14;
             for (uint32_t index2388 = 0; index2388 < size2389; index2388++){
           ivar_14 = (uint32_t)index2388;
           ivar_1->count++;
           ivar_22->elems[index2388] = (uint8_t)bytestrings__get((bytestrings__bytestring_t)ivar_1, (uint32_t)ivar_14);
             };
             release_bytestrings__bytestring(ivar_1);
             bytestrings__bytestring_t tmp2390 = new_bytestrings__bytestring();;
             result = (bytestrings__bytestring_t)tmp2390;
             tmp2390->length = (uint32_t)ivar_2;
             tmp2390->seq = (bytestrings_array_0_t)ivar_22;
};
...
bytestrings__bytestring_t bytestrings__suffix(bytestrings__bytestring_t ivar_1, uint32_t ivar_2){
        ...
        if (ivar_4){ 
             ...
             uint32_t size2404;
             //copying to uint32 from uint32;
             size2404 = (uint32_t)ivar_12;
             size2404 += 0;
             ivar_39 = new_bytestrings_array_0(size2404);
             for (uint32_t index2403 = 0; index2403 < size2404; index2403++){
           mpz_t ivar_23;
           mpz_init(ivar_23);
           mpz_set_ui(ivar_23, index2403);
           mpz_ptr_t ivar_38;
           ...
           mpz_clear(ivar_38);
           ivar_1->count++;
           ivar_39->elems[index2403] = (uint8_t)bytestrings__get((bytestrings__bytestring_t)ivar_1, (uint32_t)ivar_35);
             };
             release_bytestrings__bytestring(ivar_1);
             bytestrings__bytestring_t tmp2405 = new_bytestrings__bytestring();;
             result = (bytestrings__bytestring_t)tmp2405;
             tmp2405->length = (uint32_t)ivar_12;
             tmp2405->seq = (bytestrings_array_0_t)ivar_39;
};
...
bool_t bytestrings__ascii_bytestringp(bytestrings__bytestring_t ivar_1){
        ...
        highvar2415 = (uint32_t)ivar_3->length;
        highvar2415 += 0;
        for (uint32_t ivar_2 = low2414; ivar_2 < highvar2415; ivar_2++){
             uint8_t ivar_4;
             ivar_1->count++;
