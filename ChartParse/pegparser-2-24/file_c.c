...
mpz_ptr_t h_file_closure_6(file__lifted_file_adt_t ivar_5, file_funtype_5_t ivar_2, mpz_ptr_t ivar_1){
        mpz_ptr_t result;
        bool_t ivar_18;
        ivar_5->count++;
...
mpz_ptr_t h_file_closure_9(file__lifted_file_adt_t ivar_6, file_funtype_4_t ivar_1, file_funtype_8_t ivar_3){
        mpz_ptr_t result;
        bool_t ivar_25;
        ivar_6->count++;
...
ordstruct_adt__ordstruct_adt_t h_file_closure_12(file__lifted_file_adt_t ivar_5, file_funtype_11_t ivar_2, ordstruct_adt__ordstruct_adt_t ivar_1){
...
ordstruct_adt__ordstruct_adt_t h_file_closure_14(file__lifted_file_adt_t ivar_6, file_funtype_10_t ivar_1, file_funtype_13_t ivar_3){
        ordstruct_adt__ordstruct_adt_t result;
        bool_t ivar_25;
        ivar_6->count++;
        ivar_25 = (bool_t)r_file__failp((file__lifted_file_adt_t)ivar_6);
...
bool_t r_file__failp(file__lifted_file_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)0;
        uint8_t ivar_2;
...
bool_t r_file__passp(file__lifted_file_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)1;
        uint8_t ivar_2;
...
file__file_t file__lifted_file_adt_contents(file__lifted_file_adt_t ivar_1){
        file__file_t  result;
        file__pass_t ivar_2;
        //copying to file__pass from file__lifted_file_adt;
        ivar_2 = (file__pass_t)ivar_1;
...
file__lifted_file_adt_t file__fail(void){
        ...
        if (!defined){
                    uint8_t ivar_1;
        ivar_1 = (uint8_t)0;
        file__lifted_file_adt_t tmp2497 = new_file__lifted_file_adt();;
        result = (file__lifted_file_adt_t)tmp2497;
        tmp2497->file__lifted_file_adt_index = (uint8_t)ivar_1;
...
file__lifted_file_adt_t file__pass(file__file_t ivar_2){
        file__lifted_file_adt_t  result;
        uint8_t ivar_1;
        ivar_1 = (uint8_t)1;
        file__pass_t tmp2498 = new_file__pass();;
        result = (file__lifted_file_adt_t)tmp2498;
        tmp2498->file__lifted_file_adt_index = (uint8_t)ivar_1;
        tmp2498->contents = (file__file_t)ivar_2;

        
        return result;
}

file_funtype_3_t file__lifted_file_ord(void){
...
file_funtype_4_t file__reduce_nat(mpz_ptr_t ivar_1, file_funtype_5_t ivar_2){
        file_funtype_4_t  result;
        file_closure_6_t cl2501;
        cl2501 = new_file_closure_6();
        cl2501->fvar_1 = (file_funtype_5_t)ivar_2;
        if (cl2501->fvar_1 != NULL) cl2501->fvar_1->count++;
        mpz_set(cl2501->fvar_2, ivar_1);
        release_file_funtype_5(ivar_2);
        result = (file_funtype_4_t)cl2501;

        
        return result;
}

file_funtype_4_t file__REDUCE_nat(file_funtype_4_t ivar_1, file_funtype_8_t ivar_3){
        file_funtype_4_t  result;
        file_closure_9_t cl2509;
        cl2509 = new_file_closure_9();
        cl2509->fvar_1 = (file_funtype_4_t)ivar_1;
        if (cl2509->fvar_1 != NULL) cl2509->fvar_1->count++;
        cl2509->fvar_2 = (file_funtype_8_t)ivar_3;
        if (cl2509->fvar_2 != NULL) cl2509->fvar_2->count++;
        release_file_funtype_8(ivar_3);
        release_file_funtype_4(ivar_1);
        result = (file_funtype_4_t)cl2509;

        
        return result;
}

file_funtype_10_t file__reduce_ordinal(ordstruct_adt__ordstruct_adt_t ivar_1, file_funtype_11_t ivar_2){
        file_funtype_10_t  result;
        file_closure_12_t cl2511;
        cl2511 = new_file_closure_12();
        cl2511->fvar_1 = (file_funtype_11_t)ivar_2;
        if (cl2511->fvar_1 != NULL) cl2511->fvar_1->count++;
        cl2511->fvar_2 = (ordstruct_adt__ordstruct_adt_t)ivar_1;
        if (cl2511->fvar_2 != NULL) cl2511->fvar_2->count++;
        release_file_funtype_11(ivar_2);
        release_ordstruct_adt__ordstruct_adt(ivar_1);
        result = (file_funtype_10_t)cl2511;

        
        return result;
}

file_funtype_10_t file__REDUCE_ordinal(file_funtype_10_t ivar_1, file_funtype_13_t ivar_3){
        file_funtype_10_t  result;
        file_closure_14_t cl2519;
        cl2519 = new_file_closure_14();
        cl2519->fvar_1 = (file_funtype_10_t)ivar_1;
        if (cl2519->fvar_1 != NULL) cl2519->fvar_1->count++;
        cl2519->fvar_2 = (file_funtype_13_t)ivar_3;
        if (cl2519->fvar_2 != NULL) cl2519->fvar_2->count++;
        release_file_funtype_13(ivar_3);
        release_file_funtype_10(ivar_1);
        result = (file_funtype_10_t)cl2519;
...
bytestrings__bytestring_t file__readline(file__file_t ivar_1, uint32_t ivar_2){
