...
extern uint32_t lookup_gen_strings_funtype_1(gen_strings_funtype_1_htbl_t htbl, uint8_t i, uint32_t ihash);

extern gen_strings_funtype_1_t dupdate_gen_strings_funtype_1(gen_strings_funtype_1_t a, uint8_t i, uint32_t v);
...
extern void release_gen_strings_record_4_ptr(pointer_t x, type_actual_t gen_strings_record_4);
...
extern uint32_t h_gen_strings_closure_8(mpz_ptr_t ivar_23, mpz_ptr_t ivar_2, strings__string_t ivar_1);
