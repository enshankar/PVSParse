...
mpz_ptr_t h_ltedfapeg_closure_11(ltedfapeg__ent_adt_t ivar_10, ltedfapeg_funtype_8_t ivar_5, ltedfapeg_funtype_10_t ivar_7, mpz_ptr_t ivar_4, mpz_ptr_t ivar_3, ltedfapeg_funtype_6_t ivar_1){
        mpz_ptr_t result;
        bool_t ivar_40;
        ivar_10->count++;
...
mpz_ptr_t h_ltedfapeg_closure_18(ltedfapeg__ent_adt_t ivar_12, ltedfapeg_funtype_15_t ivar_7, ltedfapeg_funtype_17_t ivar_9, ltedfapeg_funtype_5_t ivar_5, ltedfapeg_funtype_5_t ivar_3, ltedfapeg_funtype_13_t ivar_1){
        mpz_ptr_t result;
        bool_t ivar_46;
        ivar_12->count++;
...
ordstruct_adt__ordstruct_adt_t h_ltedfapeg_closure_23(ltedfapeg__ent_adt_t ivar_10, ltedfapeg_funtype_21_t ivar_5, ltedfapeg_funtype_22_t ivar_7, ordstruct_adt__ordstruct_adt_t ivar_4, ordstruct_adt__ordstruct_adt_t ivar_3, ltedfapeg_funtype_20_t ivar_1){
...
ordstruct_adt__ordstruct_adt_t h_ltedfapeg_closure_27(ltedfapeg__ent_adt_t ivar_12, ltedfapeg_funtype_25_t ivar_7, ltedfapeg_funtype_26_t ivar_9, ltedfapeg_funtype_19_t ivar_5, ltedfapeg_funtype_19_t ivar_3, ltedfapeg_funtype_24_t ivar_1){
        ordstruct_adt__ordstruct_adt_t result;
        bool_t ivar_46;
        ivar_12->count++;
        ivar_46 = (bool_t)r_ltedfapeg__failp((ltedfapeg__ent_adt_t)ivar_12);
...
mpz_ptr_t h_ltedfapeg_closure_38(ltedfapeg__prepeg_adt_t ivar_10, ltedfapeg_funtype_35_t ivar_5, ltedfapeg_funtype_37_t ivar_7, ltedfapeg_funtype_34_t ivar_3, mpz_ptr_t ivar_2, mpz_ptr_t ivar_1){
        mpz_ptr_t result;
        bool_t ivar_31;
        ivar_10->count++;
...
mpz_ptr_t h_ltedfapeg_closure_45(ltedfapeg__prepeg_adt_t ivar_12, ltedfapeg_funtype_42_t ivar_7, ltedfapeg_funtype_44_t ivar_9, ltedfapeg_funtype_40_t ivar_5, ltedfapeg_funtype_33_t ivar_3, ltedfapeg_funtype_33_t ivar_1){
        mpz_ptr_t result;
        bool_t ivar_40;
        ivar_12->count++;
...
ordstruct_adt__ordstruct_adt_t h_ltedfapeg_closure_50(ltedfapeg__prepeg_adt_t ivar_10, ltedfapeg_funtype_48_t ivar_5, ltedfapeg_funtype_49_t ivar_7, ltedfapeg_funtype_47_t ivar_3, ordstruct_adt__ordstruct_adt_t ivar_2, ordstruct_adt__ordstruct_adt_t ivar_1){
        ordstruct_adt__ordstruct_adt_t result;
        bool_t ivar_31;
        ivar_10->count++;
        ivar_31 = (bool_t)r_ltedfapeg__epsilonp((ltedfapeg__prepeg_adt_t)ivar_10);
...
ordstruct_adt__ordstruct_adt_t h_ltedfapeg_closure_54(ltedfapeg__prepeg_adt_t ivar_12, ltedfapeg_funtype_52_t ivar_7, ltedfapeg_funtype_53_t ivar_9, ltedfapeg_funtype_51_t ivar_5, ltedfapeg_funtype_46_t ivar_3, ltedfapeg_funtype_46_t ivar_1){
        ordstruct_adt__ordstruct_adt_t result;
        bool_t ivar_40;
        ivar_12->count++;
        ivar_40 = (bool_t)r_ltedfapeg__epsilonp((ltedfapeg__prepeg_adt_t)ivar_12);
...
bool_t h_ltedfapeg_closure_56(ltedfapeg__ent_adt_t ivar_4, uint32_t ivar_2, uint32_t ivar_1){
        bool_t result;
        uint64_t ivar_5;
        uint32_t ivar_8;
...
bool_t h_ltedfapeg_closure_57(ltedfapeg__ent_adt_t ivar_3, uint32_t ivar_1){
        bool_t result;
        bool_t ivar_4;
        ivar_3->count++;
...
bool_t h_ltedfapeg_closure_58(ltedfapeg__ent_adt_t ivar_3, uint32_t ivar_1){
        bool_t result;
        bool_t ivar_4;
...
bool_t h_ltedfapeg_closure_59(ltedfapeg__ent_adt_t ivar_4, uint32_t ivar_2, uint32_t ivar_1){
        bool_t result;
        bool_t ivar_5;
        bool_t ivar_7;
        ivar_4->count++;
...
bool_t h_ltedfapeg_closure_63(uint32_t ivar_5, uint8_t ivar_6, ltedfapeg_array_62_t ivar_2, uint32_t ivar_1){
        bool_t result;
...
bool_t h_ltedfapeg_closure_67(ltedfapeg__ent_adt_t ivar_6, ltedfapeg__ent_adt_t ivar_7, ltedfapeg_array_62_t ivar_3, uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2){
        bool_t result;
        /* p1 */ uint32_t ivar_8;
        ivar_6->count++;
        ...
        if (ivar_24){ 
           ...
           if (ivar_59){    
            ...
            if (ivar_73){     
             ...
             ivar_79 = (uint64_t)(ivar_8 + ivar_81);
             ivar_57 = (ivar_16 == ivar_79);
} else {
...
mpz_ptr_t h_ltedfapeg_closure_70(uint32_t ivar_4, ltedfapeg_array_69_t ivar_2, uint32_t ivar_1){
        mpz_ptr_t result;
        bool_t ivar_5;
        uint8_t ivar_7;
        ivar_7 = (uint8_t)0;
...
bool_t h_ltedfapeg_closure_73(ltedfapeg__ent_adt_t ivar_19){
        bool_t result;
...
bool_t h_ltedfapeg_closure_74(ltedfapeg__ent_adt_t ivar_9){
        bool_t result;
...
bool_t h_ltedfapeg_closure_76(uint64_t ivar_5, ltedfapeg_array_62_t ivar_2, uint32_t ivar_1){
        bool_t result;
        uint64_t ivar_6;
        ivar_2->count++;
...
bool_t h_ltedfapeg_closure_77(ltedfapeg__ent_adt_t ivar_7, ltedfapeg_array_62_t ivar_4, uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, uint64_t ivar_3){
        bool_t result;
        bool_t ivar_8;
        uint8_t ivar_9;
        ivar_7->count++;
...
bool_t h_ltedfapeg_closure_78(ltedfapeg__ent_adt_t ivar_7, ltedfapeg__ent_adt_t ivar_8, ltedfapeg_array_62_t ivar_4, uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, uint64_t ivar_3){
        bool_t result;
        bool_t ivar_9;
        uint8_t ivar_10;
        ivar_8->count++;
...
bool_t h_ltedfapeg_closure_79(ltedfapeg__ent_adt_t ivar_7, ltedfapeg_array_62_t ivar_4, uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, uint64_t ivar_3){
        bool_t result;
        bool_t ivar_8;
        uint8_t ivar_9;
        ivar_7->count++;
...
bool_t h_ltedfapeg_closure_83(ltedfapeg_array_62_t ivar_6, uint32_t ivar_8, uint8_t ivar_9, uint64_t ivar_10, ltedfapeg_array_82_t ivar_3, uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2){
        bool_t result;
        ...
        bool_t ivar_38;
        ivar_11->count++;
        ivar_38 = (bool_t)r_ltedfapeg__anyp((ltedfapeg__prepeg_adt_t)ivar_11);
        if (ivar_38){ 
             release_ltedfapeg_array_62(ivar_6);
             dfa__dfa_t ivar_16;
             ivar_16 = (dfa__dfa_t)ltedfapeg__prepeg_adt_dfa((ltedfapeg__prepeg_adt_t)ivar_11);
             bool_t ivar_20;
             dfa__dfaResult_adt_t ivar_33;
             ivar_3->count++;
             ivar_33 = (dfa__dfaResult_adt_t)dfa__DfaParse((dfa__dfa_t)ivar_16, (uint32_t)ivar_1, (dfa_array_17_t)ivar_3, (uint32_t)ivar_8);
             ivar_20 = (bool_t)r_dfa__failedp((dfa__dfaResult_adt_t)ivar_33);
             if (ivar_20){  
           uint8_t ivar_35;
           ivar_35 = (uint8_t)0;
           result = (ivar_10 == ivar_35);
} else {
           ...
           result = (bool_t) false;
             ...
             bool_t ivar_65;
             ivar_11->count++;
             ivar_65 = (bool_t)r_ltedfapeg__terminalp((ltedfapeg__prepeg_adt_t)ivar_11);
             if (ivar_65){  
           release_ltedfapeg_array_62(ivar_6);
           uint8_t ivar_42;
           ivar_42 = (uint8_t)ltedfapeg__prepeg_adt_a((ltedfapeg__prepeg_adt_t)ivar_11);
           bool_t ivar_46;
           bool_t ivar_48;
           ivar_48 = (ivar_8 == ivar_1);
           if (ivar_48){   
           ivar_46 = (bool_t) true;
} else {
           
           uint8_t ivar_54;
           ivar_54 = (uint8_t)ivar_3->elems[ivar_8];
           ivar_46 = (ivar_42 != ivar_54);
};
           if (ivar_46){   
           uint8_t ivar_62;
           ivar_62 = (uint8_t)0;
           result = (ivar_10 == ivar_62);
} else {
           ...
           bool_t ivar_252;
           ivar_11->count++;
           ivar_252 = (bool_t)r_ltedfapeg__ltep((ltedfapeg__prepeg_adt_t)ivar_11);
           if (ivar_252){   
           uint8_t ivar_69;
           ivar_11->count++;
           ivar_69 = (uint8_t)ltedfapeg__prepeg_adt_fst((ltedfapeg__prepeg_adt_t)ivar_11);
           uint8_t ivar_70;
           ivar_11->count++;
           ivar_70 = (uint8_t)ltedfapeg__prepeg_adt_lthen((ltedfapeg__prepeg_adt_t)ivar_11);
           uint8_t ivar_71;
           ivar_71 = (uint8_t)ltedfapeg__prepeg_adt_lelse((ltedfapeg__prepeg_adt_t)ivar_11);
           bool_t ivar_81;
           bool_t ivar_83;
           ltedfapeg__ent_adt_t ivar_96;
           ltedfapeg_array_61_t ivar_88;
           ivar_88 = (ltedfapeg_array_61_t)ivar_6->elems[ivar_8];
           ivar_88->count++;
           ivar_96 = (ltedfapeg__ent_adt_t)ivar_88->elems[ivar_69];
           ivar_96->count++;
           release_ltedfapeg_array_61(ivar_88);
           ivar_83 = (bool_t)r_ltedfapeg__failp((ltedfapeg__ent_adt_t)ivar_96);
           if (ivar_83){    
            bool_t ivar_97;
            ltedfapeg__ent_adt_t ivar_110;
            ltedfapeg_array_61_t ivar_102;
            ivar_102 = (ltedfapeg_array_61_t)ivar_6->elems[ivar_8];
            ivar_102->count++;
            ivar_110 = (ltedfapeg__ent_adt_t)ivar_102->elems[ivar_71];
            ivar_110->count++;
            release_ltedfapeg_array_61(ivar_102);
            ivar_97 = (bool_t)r_ltedfapeg__failp((ltedfapeg__ent_adt_t)ivar_110);
            if (ivar_97){     
             mpz_ptr_t ivar_112;
             uint8_t ivar_113;
             ivar_113 = (uint8_t)1;
             mpq_ptr_t ivar_114;
             uint64_t ivar_147;
             ltedfapeg__ent_adt_t ivar_128;
             ltedfapeg_array_61_t ivar_120;
             ivar_120 = (ltedfapeg_array_61_t)ivar_6->elems[ivar_8];
             ivar_120->count++;
             ivar_128 = (ltedfapeg__ent_adt_t)ivar_120->elems[ivar_69];
             ivar_128->count++;
             release_ltedfapeg_array_61(ivar_120);
             ivar_147 = (uint64_t)ltedfapeg__ent_adt_dep((ltedfapeg__ent_adt_t)ivar_128);
             mpq_ptr_t ivar_142;
             //copying to mpq from uint64;
             mpq_mk_set_ui(ivar_142, ivar_147);
             uint64_t ivar_146;
             ltedfapeg__ent_adt_t ivar_140;
             ltedfapeg_array_61_t ivar_132;
             ivar_132 = (ltedfapeg_array_61_t)ivar_6->elems[ivar_8];
             ivar_132->count++;
             ivar_140 = (ltedfapeg__ent_adt_t)ivar_132->elems[ivar_71];
             ivar_140->count++;
             release_ltedfapeg_array_61(ivar_132);
             ivar_146 = (uint64_t)ltedfapeg__ent_adt_dep((ltedfapeg__ent_adt_t)ivar_140);
             mpq_ptr_t ivar_143;
             //copying to mpq from uint64;
             mpq_mk_set_ui(ivar_143, ivar_146);
             ivar_114 = (mpq_ptr_t)real_defs__max((mpq_ptr_t)ivar_142, (mpq_ptr_t)ivar_143);
             mpz_mk_set_q(ivar_112, ivar_114);
             mpz_add_ui(ivar_112, ivar_112, ivar_113);
             int64_t tmp5219 = mpz_cmp_ui(ivar_112, ivar_10);
             ivar_81 = (tmp5219 == 0);
} else {
            
             ivar_81 = (bool_t) false;
};
} else {
           ...
           if (ivar_81){    
            ...
            bool_t ivar_152;
            ltedfapeg__ent_adt_t ivar_165;
            ltedfapeg_array_61_t ivar_157;
            ivar_157 = (ltedfapeg_array_61_t)ivar_6->elems[ivar_8];
            ivar_157->count++;
            ivar_165 = (ltedfapeg__ent_adt_t)ivar_157->elems[ivar_69];
            ivar_165->count++;
            release_ltedfapeg_array_61(ivar_157);
            ivar_152 = (bool_t)r_ltedfapeg__goodp((ltedfapeg__ent_adt_t)ivar_165);
            if (ivar_152){     
             bool_t ivar_166;
             ltedfapeg__ent_adt_t ivar_194;
             ltedfapeg_array_61_t ivar_171;
             uint32_t ivar_191;
             uint32_t ivar_174;
             ltedfapeg__ent_adt_t ivar_186;
             ltedfapeg_array_61_t ivar_178;
             ivar_178 = (ltedfapeg_array_61_t)ivar_6->elems[ivar_8];
             ivar_178->count++;
             ivar_186 = (ltedfapeg__ent_adt_t)ivar_178->elems[ivar_69];
             ivar_186->count++;
             release_ltedfapeg_array_61(ivar_178);
             ivar_174 = (uint32_t)ltedfapeg__ent_adt_span((ltedfapeg__ent_adt_t)ivar_186);
             ivar_191 = (uint32_t)(ivar_8 + ivar_174);
             ivar_171 = (ltedfapeg_array_61_t)ivar_6->elems[ivar_191];
             ivar_171->count++;
             ivar_194 = (ltedfapeg__ent_adt_t)ivar_171->elems[ivar_70];
             ivar_194->count++;
             release_ltedfapeg_array_61(ivar_171);
             ivar_166 = (bool_t)r_ltedfapeg__failp((ltedfapeg__ent_adt_t)ivar_194);
             if (ivar_166){      
              mpz_ptr_t ivar_196;
              uint8_t ivar_197;
              ivar_197 = (uint8_t)1;
              ...
              ltedfapeg_array_61_t ivar_204;
              ivar_204 = (ltedfapeg_array_61_t)ivar_6->elems[ivar_8];
              ivar_204->count++;
              ivar_212 = (ltedfapeg__ent_adt_t)ivar_204->elems[ivar_69];
              ivar_212->count++;
              release_ltedfapeg_array_61(ivar_204);
              ivar_246 = (uint64_t)ltedfapeg__ent_adt_dep((ltedfapeg__ent_adt_t)ivar_212);
              mpq_ptr_t ivar_241;
              //copying to mpq from uint64;
              mpq_mk_set_ui(ivar_241, ivar_246);
              uint64_t ivar_245;
              ltedfapeg__ent_adt_t ivar_239;
              ltedfapeg_array_61_t ivar_216;
              uint32_t ivar_236;
              uint32_t ivar_219;
              ltedfapeg__ent_adt_t ivar_231;
              ltedfapeg_array_61_t ivar_223;
              ivar_223 = (ltedfapeg_array_61_t)ivar_6->elems[ivar_8];
              ivar_223->count++;
              ivar_231 = (ltedfapeg__ent_adt_t)ivar_223->elems[ivar_69];
              ivar_231->count++;
              release_ltedfapeg_array_61(ivar_223);
              ivar_219 = (uint32_t)ltedfapeg__ent_adt_span((ltedfapeg__ent_adt_t)ivar_231);
              ivar_236 = (uint32_t)(ivar_8 + ivar_219);
              ivar_216 = (ltedfapeg_array_61_t)ivar_6->elems[ivar_236];
              ivar_216->count++;
              release_ltedfapeg_array_62(ivar_6);
              ivar_239 = (ltedfapeg__ent_adt_t)ivar_216->elems[ivar_70];
              ivar_239->count++;
              release_ltedfapeg_array_61(ivar_216);
              ivar_245 = (uint64_t)ltedfapeg__ent_adt_dep((ltedfapeg__ent_adt_t)ivar_239);
              mpq_ptr_t ivar_242;
              //copying to mpq from uint64;
              mpq_mk_set_ui(ivar_242, ivar_245);
              ivar_198 = (mpq_ptr_t)real_defs__max((mpq_ptr_t)ivar_241, (mpq_ptr_t)ivar_242);
              mpz_mk_set_q(ivar_196, ivar_198);
              mpz_add_ui(ivar_196, ivar_196, ivar_197);
              int64_t tmp5220 = mpz_cmp_ui(ivar_196, ivar_10);
              result = (tmp5220 == 0);
} else {
           ...
           release_ltedfapeg_array_62(ivar_6);
           bool_t ivar_259;
           ivar_259 = (bool_t)r_ltedfapeg__failurep((ltedfapeg__prepeg_adt_t)ivar_11);
           if (ivar_259){    
            uint8_t ivar_257;
            ivar_257 = (uint8_t)0;
            result = (ivar_10 == ivar_257);
} else {
...
bool_t h_ltedfapeg_closure_86(ltedfapeg_array_62_t ivar_5, uint32_t ivar_7, uint8_t ivar_8, uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2){
        bool_t result;
...
bool_t h_ltedfapeg_closure_89(ltedfapeg_array_62_t ivar_9, uint32_t ivar_11, uint8_t ivar_12, uint64_t ivar_13, mpz_ptr_t ivar_14, ltedfapeg_array_82_t ivar_3, uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2){
        bool_t result;
        ...
        if (ivar_32){ 
             ...
             uint8_t ivar_26;
             ivar_26 = (uint8_t)0;
             int64_t tmp5273 = mpz_cmp_ui(ivar_14, ivar_26);
             ivar_23 = (tmp5273 == 0);
             if (ivar_23){  
           uint8_t ivar_29;
           ivar_29 = (uint8_t)0;
           ...
           ivar_3->count++;
           ivar_40 = (dfa__dfaResult_adt_t)dfa__DfaParse((dfa__dfa_t)ivar_36, (uint32_t)ivar_1, (dfa_array_17_t)ivar_3, (uint32_t)ivar_11);
           bool_t ivar_50;
           ivar_40->count++;
           ...
           int64_t tmp5274 = mpz_cmp_ui(ivar_14, ivar_58);
           ivar_55 = (tmp5274 == 0);
           if (ivar_55){    
            uint8_t ivar_64;
            ivar_64 = (uint8_t)0;
           ...
           uint8_t ivar_79;
           ivar_79 = (uint8_t)1;
           int64_t tmp5275 = mpz_cmp_ui(ivar_14, ivar_79);
           ivar_76 = (tmp5275 == 0);
           if (ivar_76){    
            bool_t ivar_81;
            uint8_t ivar_83;
           ...
           if (ivar_282){    
            ...
            if (ivar_113){     
             ...
             if (ivar_127){      
              ...
              int64_t tmp5276 = mpz_cmp_ui(ivar_157, ivar_13);
              ivar_111 = (tmp5276 == 0);
} else {
            ...
            if (ivar_111){     
             ...
             if (ivar_212){      
              ...
              if (ivar_226){       
               ...
               int64_t tmp5277 = mpz_cmp_ui(ivar_241, ivar_13);
               result = (tmp5277 == 0);
} else {
...
bool_t h_ltedfapeg_closure_92(ltedfapeg_array_62_t ivar_6, uint32_t ivar_8, uint8_t ivar_9, ltedfapeg__ent_adt_t ivar_10, uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        bool_t result;
        bool_t ivar_37;
        ivar_10->count++;
...
bool_t h_ltedfapeg_closure_93(ltedfapeg_array_62_t ivar_6, uint32_t ivar_8, uint8_t ivar_9, ltedfapeg__ent_adt_t ivar_10, uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        bool_t result;
        bool_t ivar_37;
        ivar_10->count++;
        ivar_37 = (bool_t)r_ltedfapeg__failp((ltedfapeg__ent_adt_t)ivar_10);
...
bool_t h_ltedfapeg_closure_95(ltedfapeg_array_62_t ivar_6, uint32_t ivar_1){
        bool_t result;
...
bool_t h_ltedfapeg_closure_96(uint32_t ivar_5, uint8_t ivar_6, ltedfapeg_array_62_t ivar_2, uint32_t ivar_1){
        bool_t result;
        bool_t ivar_7;
...
ltedfapeg_funtype_94_t h_ltedfapeg_closure_98(uint32_t ivar_7, uint8_t ivar_8, ltedfapeg_array_82_t ivar_3, ltedfapeg__lang_spec_t ivar_2, uint32_t ivar_1){
        ltedfapeg_funtype_94_t result;
        ltedfapeg_closure_99_t cl5429;
        cl5429 = new_ltedfapeg_closure_99();
        cl5429->fvar_1 = (uint32_t)ivar_7;
        cl5429->fvar_2 = (uint32_t)ivar_1;
        cl5429->fvar_3 = (uint8_t)ivar_8;
        cl5429->fvar_4 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5429->fvar_4 != NULL) cl5429->fvar_4->count++;
        cl5429->fvar_5 = (ltedfapeg_array_82_t)ivar_3;
        if (cl5429->fvar_5 != NULL) cl5429->fvar_5->count++;
        result = (ltedfapeg_funtype_94_t)cl5429;
...
bool_t h_ltedfapeg_closure_99(ltedfapeg_array_62_t ivar_11, uint32_t ivar_7, uint32_t ivar_1, uint8_t ivar_8, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        bool_t result;
        bool_t ivar_13;
...
ltedfapeg_record_100_t h_ltedfapeg_closure_102(ltedfapeg_record_100_t ivar_9, uint32_t ivar_1, ltedfapeg_array_82_t ivar_3, ltedfapeg__lang_spec_t ivar_2){
        ...
        if (ivar_26){ 
	     ...
	     //	     printf("\npos = %u, cur = %u, char = %c", ivar_31, ivar_35, ivar_3->elems[ivar_31]);
	     ...
	     //printf("G(cur) = %u", ivar_49->ltedfapeg__prepeg_adt_index);     
             ivar_49->count++;
             bool_t ivar_95;
             ivar_49->count++;
           ...
           if (ivar_206){    
            ...
            ivar_3->count++;
            ivar_144 = (dfa__dfaResult_adt_t)dfa__DfaParse((dfa__dfa_t)ivar_140, (uint32_t)ivar_1, (dfa_array_17_t)ivar_3, (uint32_t)ivar_31);
              ...
              if (ivar_741){       
               ...
               if (ivar_583){        
                ...
                if (ivar_647){         
                 ...
                 mpz_clear(ivar_618);
                 uint64_t ivar_617;
                 ivar_617 = (uint64_t)(ivar_512 + ivar_588);
                 uint32_t ivar_614;
                 //copying to uint32 from uint64;
                 ivar_614 = (uint32_t)ivar_617;
                 ...
                 if (ivar_700){          
                  ...
                  uint64_t ivar_664;
                  ivar_664 = (uint64_t)(ivar_31 + ivar_512);
                  uint32_t ivar_661;
                  //copying to uint32 from uint64;
                  ivar_661 = (uint32_t)ivar_664;
...
void release_ltedfapeg_funtype_103(ltedfapeg_funtype_103_t x){
        x->count--;
            if (x->count <= 0)

                x->ftbl->rptr(x);}

ltedfapeg_funtype_103_t copy_ltedfapeg_funtype_103(ltedfapeg_funtype_103_t x){return x->ftbl->cptr(x);}

bool_t equal_ltedfapeg_funtype_103(ltedfapeg_funtype_103_t x, ltedfapeg_funtype_103_t y){
        return false;}

char* json_ltedfapeg_funtype_103(ltedfapeg_funtype_103_t x){char * result = safe_malloc(31); sprintf(result, "%s", "\"ltedfapeg_funtype_103\""); return result;}
...
ordstruct_adt__ordstruct_adt_t f_ltedfapeg_closure_104(struct ltedfapeg_closure_104_s * closure, ltedfapeg_record_100_t bvar){
        ordstruct_adt__ordstruct_adt_t result = h_ltedfapeg_closure_104(bvar, closure->fvar_1); 
        return result;}
...
ordstruct_adt__ordstruct_adt_t m_ltedfapeg_closure_104(struct ltedfapeg_closure_104_s * closure, ltedfapeg_record_100_t bvar){
        return h_ltedfapeg_closure_104(bvar, closure->fvar_1);}

ordstruct_adt__ordstruct_adt_t h_ltedfapeg_closure_104(ltedfapeg_record_100_t ivar_8, uint32_t ivar_1){
        ordstruct_adt__ordstruct_adt_t result;
        uint64_t ivar_45;
        ...
        ltedfapeg_closure_105_t cl5614;
        cl5614 = new_ltedfapeg_closure_105();
        ivar_27 = (ltedfapeg_funtype_55_t)cl5614;
...
ltedfapeg_closure_104_t new_ltedfapeg_closure_104(void){
        static struct ltedfapeg_funtype_103_ftbl_s ftbl = {.fptr = (ordstruct_adt__ordstruct_adt_t (*)(ltedfapeg_funtype_103_t, ltedfapeg_record_100_t))&f_ltedfapeg_closure_104, .mptr = (ordstruct_adt__ordstruct_adt_t (*)(ltedfapeg_funtype_103_t, ltedfapeg_record_100_t))&m_ltedfapeg_closure_104, .rptr =  (void (*)(ltedfapeg_funtype_103_t))&release_ltedfapeg_closure_104, .cptr = (ltedfapeg_funtype_103_t (*)(ltedfapeg_funtype_103_t))&copy_ltedfapeg_closure_104};
        ltedfapeg_closure_104_t tmp = (ltedfapeg_closure_104_t) safe_malloc(sizeof(struct ltedfapeg_closure_104_s));
        tmp->count = 1;
        tmp->ftbl = &ftbl;
        tmp->htbl = NULL;
        return tmp;}
...
void release_ltedfapeg_closure_104(ltedfapeg_funtype_103_t closure){
        ltedfapeg_closure_104_t x = (ltedfapeg_closure_104_t)closure;
        x->count--;
        if (x->count <= 0){
        //printf("\nFreeing\n");
        safe_free(x);}}
...
ltedfapeg_closure_104_t copy_ltedfapeg_closure_104(ltedfapeg_closure_104_t x){
        ltedfapeg_closure_104_t y = new_ltedfapeg_closure_104();
        y->ftbl = x->ftbl;

        y->fvar_1 = (uint32_t)x->fvar_1;
        if (x->htbl != NULL){
            ltedfapeg_funtype_103_htbl_t new_htbl = (ltedfapeg_funtype_103_htbl_t) safe_malloc(sizeof(struct ltedfapeg_funtype_103_htbl_s));
            new_htbl->size = x->htbl->size;
            new_htbl->num_entries = x->htbl->num_entries;
            ltedfapeg_funtype_103_hashentry_t * new_data = (ltedfapeg_funtype_103_hashentry_t *) safe_malloc(new_htbl->size * sizeof(struct ltedfapeg_funtype_103_hashentry_s));
            memcpy(new_data, x->htbl->data, (new_htbl->size * sizeof(struct ltedfapeg_funtype_103_hashentry_s)));
            new_htbl->data = new_data;
            for (uint32_t j = 0; j < new_htbl->size; j++){
                        if ((new_htbl->data[j].key != 0) || new_htbl->data[j].keyhash != 0) new_htbl->data[j].value->count++;};
            y->htbl = new_htbl;
...
bool_t f_ltedfapeg_closure_105(struct ltedfapeg_closure_105_s * closure, ltedfapeg__ent_adt_t bvar){
        bool_t result = h_ltedfapeg_closure_105(bvar); 
        return result;}

bool_t m_ltedfapeg_closure_105(struct ltedfapeg_closure_105_s * closure, ltedfapeg__ent_adt_t bvar){
        return h_ltedfapeg_closure_105(bvar);}

bool_t h_ltedfapeg_closure_105(ltedfapeg__ent_adt_t ivar_19){
        bool_t result;
...
ltedfapeg_closure_105_t new_ltedfapeg_closure_105(void){
        static struct ltedfapeg_funtype_55_ftbl_s ftbl = {.fptr = (bool_t (*)(ltedfapeg_funtype_55_t, ltedfapeg__ent_adt_t))&f_ltedfapeg_closure_105, .mptr = (bool_t (*)(ltedfapeg_funtype_55_t, ltedfapeg__ent_adt_t))&m_ltedfapeg_closure_105, .rptr =  (void (*)(ltedfapeg_funtype_55_t))&release_ltedfapeg_closure_105, .cptr = (ltedfapeg_funtype_55_t (*)(ltedfapeg_funtype_55_t))&copy_ltedfapeg_closure_105};
...
void release_ltedfapeg_funtype_106(ltedfapeg_funtype_106_t x){
        x->count--;
            if (x->count <= 0)

                x->ftbl->rptr(x);}

ltedfapeg_funtype_106_t copy_ltedfapeg_funtype_106(ltedfapeg_funtype_106_t x){return x->ftbl->cptr(x);}

uint32_t lookup_ltedfapeg_funtype_106(ltedfapeg_funtype_106_htbl_t htbl, uint8_t i, uint32_t ihash){
        uint32_t mask = htbl->size - 1;
        uint32_t hashindex = ihash & mask;
        ltedfapeg_funtype_106_hashentry_t data = htbl->data[hashindex];
        bool_t keyzero;
...
ltedfapeg_funtype_106_t dupdate_ltedfapeg_funtype_106(ltedfapeg_funtype_106_t a, uint8_t i, ltedfapeg__ent_adt_t v){
        ltedfapeg_funtype_106_htbl_t htbl = a->htbl;
        if (htbl == NULL){//construct new htbl
                htbl = (ltedfapeg_funtype_106_htbl_t)safe_malloc(sizeof(struct ltedfapeg_funtype_106_htbl_s));
                htbl->size = HTBL_DEFAULT_SIZE; htbl->num_entries = 0;
                htbl->data = (ltedfapeg_funtype_106_hashentry_t *)safe_malloc(HTBL_DEFAULT_SIZE * sizeof(struct ltedfapeg_funtype_106_hashentry_s));
                for (uint32_t j = 0; j < HTBL_DEFAULT_SIZE; j++){htbl->data[j].key = (uint8_t)0; htbl->data[j].keyhash = 0;
                }
                a->htbl = htbl;
        }
        uint32_t size = htbl->size;
        uint32_t num_entries = htbl->num_entries;
        ltedfapeg_funtype_106_hashentry_t * data = htbl->data;
        if (num_entries/3 >  size/5){//resize data
                uint32_t new_size = 2*size; uint32_t new_mask = new_size - 1;
                if (size >= HTBL_MAX_SIZE) out_of_memory();
                ltedfapeg_funtype_106_hashentry_t * new_data = (ltedfapeg_funtype_106_hashentry_t *)safe_malloc(new_size * sizeof(struct ltedfapeg_funtype_106_hashentry_s));
                for (uint32_t j = 0; j < new_size; j++){
                        new_data[j].key = 0;
                        new_data[j].keyhash = 0;}
                for (uint32_t j = 0; j < size; j++){//transfer entries
                ...
                safe_free(data);}
        uint32_t ihash = uint32_hash(i);
        uint32_t hashindex = lookup_ltedfapeg_funtype_106(htbl, i, ihash);
        ltedfapeg_funtype_106_hashentry_t hentry = htbl->data[hashindex];
        uint32_t hkeyhash = hentry.keyhash;
        bool_t hentrykeyzero;
        hentrykeyzero = (hentry.key == 0);
...
ltedfapeg_funtype_106_t update_ltedfapeg_funtype_106(ltedfapeg_funtype_106_t a, uint8_t i, ltedfapeg__ent_adt_t v){
        if (a->count == 1){
                return dupdate_ltedfapeg_funtype_106(a, i, v);
            } else {
                ltedfapeg_funtype_106_t x = copy_ltedfapeg_funtype_106(a);
                a->count--;
                return dupdate_ltedfapeg_funtype_106(x, i, v);
            }}

bool_t equal_ltedfapeg_funtype_106(ltedfapeg_funtype_106_t x, ltedfapeg_funtype_106_t y){
        return false;}

char* json_ltedfapeg_funtype_106(ltedfapeg_funtype_106_t x){char * result = safe_malloc(31); sprintf(result, "%s", "\"ltedfapeg_funtype_106\""); return result;}


ltedfapeg__ent_adt_t f_ltedfapeg_closure_107(struct ltedfapeg_closure_107_s * closure, uint8_t bvar){
if (closure->htbl != NULL){
        ltedfapeg_funtype_106_htbl_t htbl = closure->htbl;
        uint32_t hash = uint32_hash(bvar);
        uint32_t hashindex = lookup_ltedfapeg_funtype_106(htbl, bvar, hash);
        ltedfapeg_funtype_106_hashentry_t entry = htbl->data[hashindex];
        bool_t keyzero;
         keyzero = (entry.key == 0);
        if (!keyzero || entry.keyhash != 0){
        ...
        return h_ltedfapeg_closure_107(bvar);};
...
ltedfapeg__ent_adt_t h_ltedfapeg_closure_107(uint8_t ivar_9){
        ltedfapeg__ent_adt_t result;
...
ltedfapeg_closure_107_t new_ltedfapeg_closure_107(void){
        static struct ltedfapeg_funtype_106_ftbl_s ftbl = {.fptr = (ltedfapeg__ent_adt_t (*)(ltedfapeg_funtype_106_t, uint8_t))&f_ltedfapeg_closure_107, .mptr = (ltedfapeg__ent_adt_t (*)(ltedfapeg_funtype_106_t, uint8_t))&m_ltedfapeg_closure_107, .rptr =  (void (*)(ltedfapeg_funtype_106_t))&release_ltedfapeg_closure_107, .cptr = (ltedfapeg_funtype_106_t (*)(ltedfapeg_funtype_106_t))&copy_ltedfapeg_closure_107};
        ltedfapeg_closure_107_t tmp = (ltedfapeg_closure_107_t) safe_malloc(sizeof(struct ltedfapeg_closure_107_s));
        tmp->count = 1;
        tmp->ftbl = &ftbl;
        tmp->htbl = NULL;
        return tmp;}
...
void release_ltedfapeg_closure_107(ltedfapeg_funtype_106_t closure){
        ltedfapeg_closure_107_t x = (ltedfapeg_closure_107_t)closure;
        x->count--;
        if (x->count <= 0){
        //printf("\nFreeing\n");
        safe_free(x);}}
...
ltedfapeg_closure_107_t copy_ltedfapeg_closure_107(ltedfapeg_closure_107_t x){
        ltedfapeg_closure_107_t y = new_ltedfapeg_closure_107();
        y->ftbl = x->ftbl;

        if (x->htbl != NULL){
            ltedfapeg_funtype_106_htbl_t new_htbl = (ltedfapeg_funtype_106_htbl_t) safe_malloc(sizeof(struct ltedfapeg_funtype_106_htbl_s));
            new_htbl->size = x->htbl->size;
            new_htbl->num_entries = x->htbl->num_entries;
            ltedfapeg_funtype_106_hashentry_t * new_data = (ltedfapeg_funtype_106_hashentry_t *) safe_malloc(new_htbl->size * sizeof(struct ltedfapeg_funtype_106_hashentry_s));
            memcpy(new_data, x->htbl->data, (new_htbl->size * sizeof(struct ltedfapeg_funtype_106_hashentry_s)));
            new_htbl->data = new_data;
            for (uint32_t j = 0; j < new_htbl->size; j++){
                        if ((new_htbl->data[j].key != 0) || new_htbl->data[j].keyhash != 0) new_htbl->data[j].value->count++;};
            y->htbl = new_htbl;
...
void release_ltedfapeg_funtype_108(ltedfapeg_funtype_108_t x){
        x->count--;
            if (x->count <= 0)

                x->ftbl->rptr(x);}

ltedfapeg_funtype_108_t copy_ltedfapeg_funtype_108(ltedfapeg_funtype_108_t x){return x->ftbl->cptr(x);}

uint32_t lookup_ltedfapeg_funtype_108(ltedfapeg_funtype_108_htbl_t htbl, uint32_t i, uint32_t ihash){
        uint32_t mask = htbl->size - 1;
        uint32_t hashindex = ihash & mask;
        ltedfapeg_funtype_108_hashentry_t data = htbl->data[hashindex];
        bool_t keyzero;
...
ltedfapeg_funtype_108_t dupdate_ltedfapeg_funtype_108(ltedfapeg_funtype_108_t a, uint32_t i, ltedfapeg_funtype_106_t v){
        ltedfapeg_funtype_108_htbl_t htbl = a->htbl;
        if (htbl == NULL){//construct new htbl
                htbl = (ltedfapeg_funtype_108_htbl_t)safe_malloc(sizeof(struct ltedfapeg_funtype_108_htbl_s));
                htbl->size = HTBL_DEFAULT_SIZE; htbl->num_entries = 0;
                htbl->data = (ltedfapeg_funtype_108_hashentry_t *)safe_malloc(HTBL_DEFAULT_SIZE * sizeof(struct ltedfapeg_funtype_108_hashentry_s));
                for (uint32_t j = 0; j < HTBL_DEFAULT_SIZE; j++){htbl->data[j].key = (uint32_t)0; htbl->data[j].keyhash = 0;
                }
                a->htbl = htbl;
        }
        uint32_t size = htbl->size;
        uint32_t num_entries = htbl->num_entries;
        ltedfapeg_funtype_108_hashentry_t * data = htbl->data;
        if (num_entries/3 >  size/5){//resize data
                uint32_t new_size = 2*size; uint32_t new_mask = new_size - 1;
                if (size >= HTBL_MAX_SIZE) out_of_memory();
                ltedfapeg_funtype_108_hashentry_t * new_data = (ltedfapeg_funtype_108_hashentry_t *)safe_malloc(new_size * sizeof(struct ltedfapeg_funtype_108_hashentry_s));
                for (uint32_t j = 0; j < new_size; j++){
                        new_data[j].key = 0;
                        new_data[j].keyhash = 0;}
                for (uint32_t j = 0; j < size; j++){//transfer entries
                        ...
                        if (!keyzero || keyhash != 0){
                                ...
                                new_data[new_loc].key = (uint32_t)data[j].key;
                                new_data[new_loc].keyhash = keyhash;
                                new_data[new_loc].value = (ltedfapeg_funtype_106_t)data[j].value;
                                }}
                htbl->size = new_size;
                htbl->num_entries = num_entries;
                htbl->data = new_data;
                safe_free(data);}
        uint32_t ihash = uint32_hash(i);
        uint32_t hashindex = lookup_ltedfapeg_funtype_108(htbl, i, ihash);
        ltedfapeg_funtype_108_hashentry_t hentry = htbl->data[hashindex];
        uint32_t hkeyhash = hentry.keyhash;
        bool_t hentrykeyzero;
        hentrykeyzero = (hentry.key == 0);

        if (hentrykeyzero && (hkeyhash == 0))
                {htbl->data[hashindex].key = (uint32_t)i; htbl->data[hashindex].keyhash = ihash; htbl->data[hashindex].value = (ltedfapeg_funtype_106_t)v; htbl->num_entries++;}
            else {ltedfapeg_funtype_106_t tempvalue;tempvalue = (ltedfapeg_funtype_106_t)htbl->data[hashindex].value;htbl->data[hashindex].value = (ltedfapeg_funtype_106_t)v;if (v != NULL) v->count++;if (tempvalue != NULL)release_ltedfapeg_funtype_106(tempvalue);};
        return a;

}

ltedfapeg_funtype_108_t update_ltedfapeg_funtype_108(ltedfapeg_funtype_108_t a, uint32_t i, ltedfapeg_funtype_106_t v){
        if (a->count == 1){
                return dupdate_ltedfapeg_funtype_108(a, i, v);
            } else {
                ltedfapeg_funtype_108_t x = copy_ltedfapeg_funtype_108(a);
                a->count--;
                return dupdate_ltedfapeg_funtype_108(x, i, v);
            }}

bool_t equal_ltedfapeg_funtype_108(ltedfapeg_funtype_108_t x, ltedfapeg_funtype_108_t y){
        return false;}

char* json_ltedfapeg_funtype_108(ltedfapeg_funtype_108_t x){char * result = safe_malloc(31); sprintf(result, "%s", "\"ltedfapeg_funtype_108\""); return result;}


ltedfapeg_record_109_t new_ltedfapeg_record_109(void){
        ltedfapeg_record_109_t tmp = (ltedfapeg_record_109_t) safe_malloc(sizeof(struct ltedfapeg_record_109_s));
        tmp->count = 1;
        return tmp;}

void release_ltedfapeg_record_109(ltedfapeg_record_109_t x){
        x->count--;
        if (x->count <= 0){
         release_ltedfapeg_funtype_108(x->scaf);
         release_ltedfapeg__ent_adt(x->stack);
        //printf("\nFreeing\n");
        safe_free(x);}}

void release_ltedfapeg_record_109_ptr(pointer_t x, type_actual_t T){
        release_ltedfapeg_record_109((ltedfapeg_record_109_t)x);
}

ltedfapeg_record_109_t copy_ltedfapeg_record_109(ltedfapeg_record_109_t x){
        ltedfapeg_record_109_t y = new_ltedfapeg_record_109();
...
bool_t equal_ltedfapeg_record_109(ltedfapeg_record_109_t x, ltedfapeg_record_109_t y){
        bool_t tmp = true;
        tmp = tmp && x->depth == y->depth;
        tmp = tmp && x->lflag == y->lflag;
        tmp = tmp && equal_ltedfapeg_funtype_108(x->scaf, y->scaf);
        tmp = tmp && equal_ltedfapeg__ent_adt(x->stack, y->stack);
        return tmp;}

char * json_ltedfapeg_record_109(ltedfapeg_record_109_t x){
        char * tmp[4]; 
        ...
        char * fld2 = safe_malloc(16);
         sprintf(fld2, "\"scaf\" : ");
        tmp[2] = safe_strcat(fld2, json_ltedfapeg_funtype_108(x->scaf));
        char * fld3 = safe_malloc(17);
         sprintf(fld3, "\"stack\" : ");
...
bool_t equal_ltedfapeg_record_109_ptr(pointer_t x, pointer_t y, actual_ltedfapeg_record_109_t T){
        return equal_ltedfapeg_record_109((ltedfapeg_record_109_t)x, (ltedfapeg_record_109_t)y);
}

char * json_ltedfapeg_record_109_ptr(pointer_t x, actual_ltedfapeg_record_109_t T){
        return json_ltedfapeg_record_109((ltedfapeg_record_109_t)x);
}

actual_ltedfapeg_record_109_t actual_ltedfapeg_record_109(){
        actual_ltedfapeg_record_109_t new = (actual_ltedfapeg_record_109_t)safe_malloc(sizeof(struct actual_ltedfapeg_record_109_s));
        new->equal_ptr = (equal_ptr_t)(*equal_ltedfapeg_record_109_ptr);
 
        new->release_ptr = (release_ptr_t)(*release_ltedfapeg_record_109_ptr);
 
        new->json_ptr = (json_ptr_t)(*json_ltedfapeg_record_109_ptr);
...
ltedfapeg_record_109_t update_ltedfapeg_record_109_depth(ltedfapeg_record_109_t x, uint8_t v){
        ltedfapeg_record_109_t y;
        if (x->count == 1){y = x;}
        else {y = copy_ltedfapeg_record_109(x); x->count--;};
        y->depth = (uint8_t)v;
        return y;}

ltedfapeg_record_109_t update_ltedfapeg_record_109_lflag(ltedfapeg_record_109_t x, bool_t v){
        ltedfapeg_record_109_t y;
        if (x->count == 1){y = x;}
        else {y = copy_ltedfapeg_record_109(x); x->count--;};
        y->lflag = (bool_t)v;
...
ltedfapeg_record_109_t update_ltedfapeg_record_109_scaf(ltedfapeg_record_109_t x, ltedfapeg_funtype_108_t v){
        ltedfapeg_record_109_t y;
        if (v != NULL){v->count++;};
        if (x->count == 1){y = x; if (x->scaf != NULL){release_ltedfapeg_funtype_108(x->scaf);};}
        else {y = copy_ltedfapeg_record_109(x); x->count--; y->scaf->count--;};
        y->scaf = (ltedfapeg_funtype_108_t)v;
        return y;}

ltedfapeg_record_109_t update_ltedfapeg_record_109_stack(ltedfapeg_record_109_t x, ltedfapeg__ent_adt_t v){
        ltedfapeg_record_109_t y;
        if (v != NULL){v->count++;};
        if (x->count == 1){y = x; if (x->stack != NULL){release_ltedfapeg__ent_adt(x->stack);};}
        else {y = copy_ltedfapeg_record_109(x); x->count--; y->stack->count--;};
        y->stack = (ltedfapeg__ent_adt_t)v;
        return y;}
...
if (closure->htbl != NULL){
        ltedfapeg_funtype_108_htbl_t htbl = closure->htbl;
        uint32_t hash = uint32_hash(bvar);
        uint32_t hashindex = lookup_ltedfapeg_funtype_108(htbl, bvar, hash);
        ltedfapeg_funtype_108_hashentry_t entry = htbl->data[hashindex];
        bool_t keyzero;
         keyzero = (entry.key == 0);
        if (!keyzero || entry.keyhash != 0){
            ltedfapeg_funtype_106_t result;
            result = (ltedfapeg_funtype_106_t)entry.value;
            if (result != NULL) result->count++;
            return result;}
        

        return h_ltedfapeg_closure_110(bvar, closure->fvar_1, closure->fvar_2);};
...
ltedfapeg_funtype_106_t h_ltedfapeg_closure_110(uint32_t ivar_22, uint32_t ivar_1, ltedfapeg_funtype_106_t ivar_5){
        ltedfapeg_funtype_106_t result;
        //copying to ltedfapeg_funtype_106 from ltedfapeg_funtype_106;
        result = (ltedfapeg_funtype_106_t)ivar_5;
        if (result != NULL) result->count++;
...
ltedfapeg_closure_110_t new_ltedfapeg_closure_110(void){
        static struct ltedfapeg_funtype_108_ftbl_s ftbl = {.fptr = (ltedfapeg_funtype_106_t (*)(ltedfapeg_funtype_108_t, uint32_t))&f_ltedfapeg_closure_110, .mptr = (ltedfapeg_funtype_106_t (*)(ltedfapeg_funtype_108_t, uint32_t))&m_ltedfapeg_closure_110, .rptr =  (void (*)(ltedfapeg_funtype_108_t))&release_ltedfapeg_closure_110, .cptr = (ltedfapeg_funtype_108_t (*)(ltedfapeg_funtype_108_t))&copy_ltedfapeg_closure_110};
        ltedfapeg_closure_110_t tmp = (ltedfapeg_closure_110_t) safe_malloc(sizeof(struct ltedfapeg_closure_110_s));
        tmp->count = 1;
        tmp->ftbl = &ftbl;
        tmp->htbl = NULL;
        return tmp;}
...
void release_ltedfapeg_closure_110(ltedfapeg_funtype_108_t closure){
        ltedfapeg_closure_110_t x = (ltedfapeg_closure_110_t)closure;
        x->count--;
        if (x->count <= 0){
         release_ltedfapeg_funtype_106(x->fvar_2);
        //printf("\nFreeing\n");
        safe_free(x);}}

ltedfapeg_closure_110_t copy_ltedfapeg_closure_110(ltedfapeg_closure_110_t x){
        ltedfapeg_closure_110_t y = new_ltedfapeg_closure_110();
        y->ftbl = x->ftbl;

        y->fvar_1 = (uint32_t)x->fvar_1;
        y->fvar_2 = x->fvar_2; x->fvar_2->count++;
        if (x->htbl != NULL){
            ltedfapeg_funtype_108_htbl_t new_htbl = (ltedfapeg_funtype_108_htbl_t) safe_malloc(sizeof(struct ltedfapeg_funtype_108_htbl_s));
            new_htbl->size = x->htbl->size;
            new_htbl->num_entries = x->htbl->num_entries;
            ltedfapeg_funtype_108_hashentry_t * new_data = (ltedfapeg_funtype_108_hashentry_t *) safe_malloc(new_htbl->size * sizeof(struct ltedfapeg_funtype_108_hashentry_s));
            memcpy(new_data, x->htbl->data, (new_htbl->size * sizeof(struct ltedfapeg_funtype_108_hashentry_s)));
            new_htbl->data = new_data;
            for (uint32_t j = 0; j < new_htbl->size; j++){
                        if ((new_htbl->data[j].key != 0) || new_htbl->data[j].keyhash != 0) new_htbl->data[j].value->count++;};
            y->htbl = new_htbl;
...
uint8_t ltedfapeg__num_non_terminals(void){
...
bool_t r_ltedfapeg__failp(ltedfapeg__ent_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)0;
        uint8_t ivar_2;
...
bool_t r_ltedfapeg__pendingp(ltedfapeg__ent_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)1;
        uint8_t ivar_2;
...
bool_t r_ltedfapeg__loopp(ltedfapeg__ent_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)2;
        uint8_t ivar_2;
...
bool_t r_ltedfapeg__goodp(ltedfapeg__ent_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)3;
        uint8_t ivar_2;
...
bool_t r_ltedfapeg__pushp(ltedfapeg__ent_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)4;
        uint8_t ivar_2;
...
ltedfapeg__ent_adt_t update_ltedfapeg__ent_adt_dep(ltedfapeg__ent_adt_t ivar_1, uint64_t ivar_7){
        ltedfapeg__ent_adt_t  result;
        bool_t ivar_9;
        uint32_t ivar_10;
...
uint64_t ltedfapeg__ent_adt_dep(ltedfapeg__ent_adt_t ivar_1){
        uint64_t  result;
        bool_t ivar_3;
        uint32_t ivar_4;
...
ltedfapeg__good_t update_ltedfapeg__ent_adt_span(ltedfapeg__ent_adt_t ivar_1, uint32_t ivar_3){
...
uint32_t ltedfapeg__ent_adt_span(ltedfapeg__ent_adt_t ivar_1){
        uint32_t  result;
        ltedfapeg__good_t ivar_2;
        //copying to ltedfapeg__good from ltedfapeg__ent_adt;
        ivar_2 = (ltedfapeg__good_t)ivar_1;
...
ltedfapeg__push_t update_ltedfapeg__ent_adt_pos(ltedfapeg__ent_adt_t ivar_1, uint32_t ivar_3){
...
uint32_t ltedfapeg__ent_adt_pos(ltedfapeg__ent_adt_t ivar_1){
        uint32_t  result;
        ltedfapeg__push_t ivar_2;
        //copying to ltedfapeg__push from ltedfapeg__ent_adt;
        ivar_2 = (ltedfapeg__push_t)ivar_1;
...
ltedfapeg__push_t update_ltedfapeg__ent_adt_nt(ltedfapeg__ent_adt_t ivar_1, uint8_t ivar_3){
        ltedfapeg__push_t  result;
        ltedfapeg__push_t ivar_2;
        //copying to ltedfapeg__push from ltedfapeg__ent_adt;
        ivar_2 = (ltedfapeg__push_t)ivar_1;
...
uint8_t ltedfapeg__ent_adt_nt(ltedfapeg__ent_adt_t ivar_1){
        uint8_t  result;
        ltedfapeg__push_t ivar_2;
        //copying to ltedfapeg__push from ltedfapeg__ent_adt;
        ivar_2 = (ltedfapeg__push_t)ivar_1;
...
ltedfapeg__ent_adt_t ltedfapeg__fail(uint64_t ivar_2){
        ltedfapeg__ent_adt_t  result;
        uint8_t ivar_1;
        ivar_1 = (uint8_t)0;
        ltedfapeg__fail_t tmp4911 = new_ltedfapeg__fail();;
        result = (ltedfapeg__ent_adt_t)tmp4911;
        tmp4911->ltedfapeg__ent_adt_index = (uint8_t)ivar_1;
        tmp4911->dep = (uint64_t)ivar_2;

        
        return result;
}

ltedfapeg__ent_adt_t ltedfapeg__pending(void){
        ...
        if (!defined){
                    uint8_t ivar_1;
        ivar_1 = (uint8_t)1;
        ltedfapeg__ent_adt_t tmp4912 = new_ltedfapeg__ent_adt();;
        result = (ltedfapeg__ent_adt_t)tmp4912;
        tmp4912->ltedfapeg__ent_adt_index = (uint8_t)ivar_1;
...
ltedfapeg__ent_adt_t ltedfapeg__loop(void){
        ltedfapeg__ent_adt_t  static  result;
        ...
        if (!defined){
                    uint8_t ivar_1;
        ivar_1 = (uint8_t)2;
        ltedfapeg__ent_adt_t tmp4913 = new_ltedfapeg__ent_adt();;
        result = (ltedfapeg__ent_adt_t)tmp4913;
        tmp4913->ltedfapeg__ent_adt_index = (uint8_t)ivar_1;
...
ltedfapeg__ent_adt_t ltedfapeg__good(uint64_t ivar_2, uint32_t ivar_3){
        ltedfapeg__ent_adt_t  result;
        uint8_t ivar_1;
        ivar_1 = (uint8_t)3;
        ltedfapeg__good_t tmp4914 = new_ltedfapeg__good();;
        result = (ltedfapeg__ent_adt_t)tmp4914;
        tmp4914->ltedfapeg__ent_adt_index = (uint8_t)ivar_1;
        tmp4914->dep = (uint64_t)ivar_2;
        tmp4914->span = (uint32_t)ivar_3;

        
        return result;
}

ltedfapeg__ent_adt_t ltedfapeg__push(uint32_t ivar_2, uint8_t ivar_3){
        ltedfapeg__ent_adt_t  result;
        uint8_t ivar_1;
        ivar_1 = (uint8_t)4;
        ltedfapeg__push_t tmp4915 = new_ltedfapeg__push();;
        result = (ltedfapeg__ent_adt_t)tmp4915;
        tmp4915->ltedfapeg__ent_adt_index = (uint8_t)ivar_1;
        tmp4915->pos = (uint32_t)ivar_2;
        tmp4915->nt = (uint8_t)ivar_3;

        
        return result;
}

ltedfapeg_funtype_4_t ltedfapeg__ent_ord(void){
...
uint8_t ltedfapeg__ord__1(ltedfapeg__ent_adt_t ivar_1){
        uint8_t  result;
        bool_t ivar_7;
        ivar_1->count++;
...
bool_t ltedfapeg__subterm__1(ltedfapeg__ent_adt_t ivar_1, ltedfapeg__ent_adt_t ivar_2){
        bool_t  result;
...
bool_t ltedfapeg__doublelessp__1(ltedfapeg__ent_adt_t ivar_1, ltedfapeg__ent_adt_t ivar_2){
        bool_t  result;
        result = (bool_t) false;
...
ltedfapeg_funtype_5_t ltedfapeg__reduce_nat__1(ltedfapeg_funtype_6_t ivar_1, mpz_ptr_t ivar_3, mpz_ptr_t ivar_4, ltedfapeg_funtype_8_t ivar_5, ltedfapeg_funtype_10_t ivar_7){
        ltedfapeg_funtype_5_t  result;
        ltedfapeg_closure_11_t cl4930;
        cl4930 = new_ltedfapeg_closure_11();
        cl4930->fvar_1 = (ltedfapeg_funtype_8_t)ivar_5;
        if (cl4930->fvar_1 != NULL) cl4930->fvar_1->count++;
        cl4930->fvar_2 = (ltedfapeg_funtype_10_t)ivar_7;
        if (cl4930->fvar_2 != NULL) cl4930->fvar_2->count++;
        mpz_set(cl4930->fvar_3, ivar_4);
        mpz_set(cl4930->fvar_4, ivar_3);
        cl4930->fvar_5 = (ltedfapeg_funtype_6_t)ivar_1;
        if (cl4930->fvar_5 != NULL) cl4930->fvar_5->count++;
        release_ltedfapeg_funtype_8(ivar_5);
        release_ltedfapeg_funtype_10(ivar_7);
        release_ltedfapeg_funtype_6(ivar_1);
        result = (ltedfapeg_funtype_5_t)cl4930;

        
        return result;
}

ltedfapeg_funtype_5_t ltedfapeg__REDUCE_nat__1(ltedfapeg_funtype_13_t ivar_1, ltedfapeg_funtype_5_t ivar_3, ltedfapeg_funtype_5_t ivar_5, ltedfapeg_funtype_15_t ivar_7, ltedfapeg_funtype_17_t ivar_9){
        ltedfapeg_funtype_5_t  result;
        ltedfapeg_closure_18_t cl4956;
        cl4956 = new_ltedfapeg_closure_18();
        cl4956->fvar_1 = (ltedfapeg_funtype_15_t)ivar_7;
        if (cl4956->fvar_1 != NULL) cl4956->fvar_1->count++;
        cl4956->fvar_2 = (ltedfapeg_funtype_17_t)ivar_9;
        if (cl4956->fvar_2 != NULL) cl4956->fvar_2->count++;
        cl4956->fvar_3 = (ltedfapeg_funtype_5_t)ivar_5;
        if (cl4956->fvar_3 != NULL) cl4956->fvar_3->count++;
        cl4956->fvar_4 = (ltedfapeg_funtype_5_t)ivar_3;
        if (cl4956->fvar_4 != NULL) cl4956->fvar_4->count++;
        cl4956->fvar_5 = (ltedfapeg_funtype_13_t)ivar_1;
        if (cl4956->fvar_5 != NULL) cl4956->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_5_t)cl4956;

        
        return result;
}

ltedfapeg_funtype_19_t ltedfapeg__reduce_ordinal__1(ltedfapeg_funtype_20_t ivar_1, ordstruct_adt__ordstruct_adt_t ivar_3, ordstruct_adt__ordstruct_adt_t ivar_4, ltedfapeg_funtype_21_t ivar_5, ltedfapeg_funtype_22_t ivar_7){
        ltedfapeg_funtype_19_t  result;
        ltedfapeg_closure_23_t cl4970;
        cl4970 = new_ltedfapeg_closure_23();
        cl4970->fvar_1 = (ltedfapeg_funtype_21_t)ivar_5;
        if (cl4970->fvar_1 != NULL) cl4970->fvar_1->count++;
        cl4970->fvar_2 = (ltedfapeg_funtype_22_t)ivar_7;
        if (cl4970->fvar_2 != NULL) cl4970->fvar_2->count++;
        cl4970->fvar_3 = (ordstruct_adt__ordstruct_adt_t)ivar_4;
        if (cl4970->fvar_3 != NULL) cl4970->fvar_3->count++;
        cl4970->fvar_4 = (ordstruct_adt__ordstruct_adt_t)ivar_3;
        if (cl4970->fvar_4 != NULL) cl4970->fvar_4->count++;
        cl4970->fvar_5 = (ltedfapeg_funtype_20_t)ivar_1;
        if (cl4970->fvar_5 != NULL) cl4970->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_19_t)cl4970;

        
        return result;
}

ltedfapeg_funtype_19_t ltedfapeg__REDUCE_ordinal__1(ltedfapeg_funtype_24_t ivar_1, ltedfapeg_funtype_19_t ivar_3, ltedfapeg_funtype_19_t ivar_5, ltedfapeg_funtype_25_t ivar_7, ltedfapeg_funtype_26_t ivar_9){
        ltedfapeg_funtype_19_t  result;
        ltedfapeg_closure_27_t cl4996;
        cl4996 = new_ltedfapeg_closure_27();
        cl4996->fvar_1 = (ltedfapeg_funtype_25_t)ivar_7;
        if (cl4996->fvar_1 != NULL) cl4996->fvar_1->count++;
        cl4996->fvar_2 = (ltedfapeg_funtype_26_t)ivar_9;
        if (cl4996->fvar_2 != NULL) cl4996->fvar_2->count++;
        cl4996->fvar_3 = (ltedfapeg_funtype_19_t)ivar_5;
        if (cl4996->fvar_3 != NULL) cl4996->fvar_3->count++;
        cl4996->fvar_4 = (ltedfapeg_funtype_19_t)ivar_3;
        if (cl4996->fvar_4 != NULL) cl4996->fvar_4->count++;
        cl4996->fvar_5 = (ltedfapeg_funtype_24_t)ivar_1;
        if (cl4996->fvar_5 != NULL) cl4996->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_19_t)cl4996;

        
        return result;
}

bool_t r_ltedfapeg__epsilonp(ltedfapeg__prepeg_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)0;
        uint8_t ivar_2;
...
bool_t r_ltedfapeg__failurep(ltedfapeg__prepeg_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)1;
        uint8_t ivar_2;
...
bool_t r_ltedfapeg__anyp(ltedfapeg__prepeg_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)2;
        uint8_t ivar_2;
...
bool_t r_ltedfapeg__terminalp(ltedfapeg__prepeg_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)3;
        uint8_t ivar_2;
...
bool_t r_ltedfapeg__ltep(ltedfapeg__prepeg_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_3;
        ivar_3 = (uint8_t)4;
        uint8_t ivar_2;
...
ltedfapeg__any_t update_ltedfapeg__prepeg_adt_dfa(ltedfapeg__prepeg_adt_t ivar_1, dfa__dfa_t ivar_3){
...
dfa__dfa_t ltedfapeg__prepeg_adt_dfa(ltedfapeg__prepeg_adt_t ivar_1){
        dfa__dfa_t  result;
        ltedfapeg__any_t ivar_2;
        //copying to ltedfapeg__any from ltedfapeg__prepeg_adt;
        ivar_2 = (ltedfapeg__any_t)ivar_1;
...
ltedfapeg__terminal_t update_ltedfapeg__prepeg_adt_a(ltedfapeg__prepeg_adt_t ivar_1, uint8_t ivar_3){
...
uint8_t ltedfapeg__prepeg_adt_a(ltedfapeg__prepeg_adt_t ivar_1){
        uint8_t  result;
        ltedfapeg__terminal_t ivar_2;
        //copying to ltedfapeg__terminal from ltedfapeg__prepeg_adt;
        ivar_2 = (ltedfapeg__terminal_t)ivar_1;
...
ltedfapeg__lte_t update_ltedfapeg__prepeg_adt_fst(ltedfapeg__prepeg_adt_t ivar_1, uint8_t ivar_3){
...
uint8_t ltedfapeg__prepeg_adt_fst(ltedfapeg__prepeg_adt_t ivar_1){
        uint8_t  result;
        ltedfapeg__lte_t ivar_2;
        //copying to ltedfapeg__lte from ltedfapeg__prepeg_adt;
        ivar_2 = (ltedfapeg__lte_t)ivar_1;
...
ltedfapeg__lte_t update_ltedfapeg__prepeg_adt_lthen(ltedfapeg__prepeg_adt_t ivar_1, uint8_t ivar_3){
        ltedfapeg__lte_t  result;
        ltedfapeg__lte_t ivar_2;
        //copying to ltedfapeg__lte from ltedfapeg__prepeg_adt;
        ivar_2 = (ltedfapeg__lte_t)ivar_1;
...
uint8_t ltedfapeg__prepeg_adt_lthen(ltedfapeg__prepeg_adt_t ivar_1){
        uint8_t  result;
        ltedfapeg__lte_t ivar_2;
        //copying to ltedfapeg__lte from ltedfapeg__prepeg_adt;
        ivar_2 = (ltedfapeg__lte_t)ivar_1;
...
ltedfapeg__lte_t update_ltedfapeg__prepeg_adt_lelse(ltedfapeg__prepeg_adt_t ivar_1, uint8_t ivar_3){
        ltedfapeg__lte_t  result;
        ltedfapeg__lte_t ivar_2;
        //copying to ltedfapeg__lte from ltedfapeg__prepeg_adt;
        ivar_2 = (ltedfapeg__lte_t)ivar_1;
...
uint8_t ltedfapeg__prepeg_adt_lelse(ltedfapeg__prepeg_adt_t ivar_1){
        uint8_t  result;
        ltedfapeg__lte_t ivar_2;
        //copying to ltedfapeg__lte from ltedfapeg__prepeg_adt;
        ivar_2 = (ltedfapeg__lte_t)ivar_1;
...
ltedfapeg__prepeg_adt_t ltedfapeg__epsilon(void){
        ...
        if (!defined){
                    uint8_t ivar_1;
        ivar_1 = (uint8_t)0;
        ltedfapeg__prepeg_adt_t tmp5014 = new_ltedfapeg__prepeg_adt();;
        result = (ltedfapeg__prepeg_adt_t)tmp5014;
        tmp5014->ltedfapeg__prepeg_adt_index = (uint8_t)ivar_1;
...
ltedfapeg__prepeg_adt_t ltedfapeg__failure(void){
        ltedfapeg__prepeg_adt_t  static  result;
        ...
        if (!defined){
                    uint8_t ivar_1;
        ivar_1 = (uint8_t)1;
        ltedfapeg__prepeg_adt_t tmp5015 = new_ltedfapeg__prepeg_adt();;
        result = (ltedfapeg__prepeg_adt_t)tmp5015;
        tmp5015->ltedfapeg__prepeg_adt_index = (uint8_t)ivar_1;
...
ltedfapeg__prepeg_adt_t ltedfapeg__any(dfa__dfa_t ivar_2){
        ltedfapeg__prepeg_adt_t  result;
        uint8_t ivar_1;
        ivar_1 = (uint8_t)2;
        ltedfapeg__any_t tmp5016 = new_ltedfapeg__any();;
        result = (ltedfapeg__prepeg_adt_t)tmp5016;
        tmp5016->ltedfapeg__prepeg_adt_index = (uint8_t)ivar_1;
        tmp5016->dfa = (dfa__dfa_t)ivar_2;

        
        return result;
}

ltedfapeg__prepeg_adt_t ltedfapeg__terminal(uint8_t ivar_2){
        ltedfapeg__prepeg_adt_t  result;
        uint8_t ivar_1;
        ivar_1 = (uint8_t)3;
        ltedfapeg__terminal_t tmp5017 = new_ltedfapeg__terminal();;
        result = (ltedfapeg__prepeg_adt_t)tmp5017;
        tmp5017->ltedfapeg__prepeg_adt_index = (uint8_t)ivar_1;
        tmp5017->a = (uint8_t)ivar_2;

        
        return result;
}

ltedfapeg__prepeg_adt_t ltedfapeg__lte(uint8_t ivar_2, uint8_t ivar_3, uint8_t ivar_4){
        ltedfapeg__prepeg_adt_t  result;
        uint8_t ivar_1;
        ivar_1 = (uint8_t)4;
        ltedfapeg__lte_t tmp5018 = new_ltedfapeg__lte();;
        result = (ltedfapeg__prepeg_adt_t)tmp5018;
        tmp5018->ltedfapeg__prepeg_adt_index = (uint8_t)ivar_1;
        tmp5018->fst = (uint8_t)ivar_2;
        tmp5018->lthen = (uint8_t)ivar_3;
        tmp5018->lelse = (uint8_t)ivar_4;

        
        return result;
}

ltedfapeg_funtype_32_t ltedfapeg__prepeg_ord(void){
...
uint8_t ltedfapeg__ord__2(ltedfapeg__prepeg_adt_t ivar_1){
        uint8_t  result;
        bool_t ivar_3;
        ivar_1->count++;
...
bool_t ltedfapeg__subterm__2(ltedfapeg__prepeg_adt_t ivar_1, ltedfapeg__prepeg_adt_t ivar_2){
        bool_t  result;
...
bool_t ltedfapeg__doublelessp__2(ltedfapeg__prepeg_adt_t ivar_1, ltedfapeg__prepeg_adt_t ivar_2){
        bool_t  result;
        result = (bool_t) false;
...
ltedfapeg_funtype_33_t ltedfapeg__reduce_nat__2(mpz_ptr_t ivar_1, mpz_ptr_t ivar_2, ltedfapeg_funtype_34_t ivar_3, ltedfapeg_funtype_35_t ivar_5, ltedfapeg_funtype_37_t ivar_7){
        ltedfapeg_funtype_33_t  result;
        ltedfapeg_closure_38_t cl5030;
        cl5030 = new_ltedfapeg_closure_38();
        cl5030->fvar_1 = (ltedfapeg_funtype_35_t)ivar_5;
        if (cl5030->fvar_1 != NULL) cl5030->fvar_1->count++;
        cl5030->fvar_2 = (ltedfapeg_funtype_37_t)ivar_7;
        if (cl5030->fvar_2 != NULL) cl5030->fvar_2->count++;
        cl5030->fvar_3 = (ltedfapeg_funtype_34_t)ivar_3;
        if (cl5030->fvar_3 != NULL) cl5030->fvar_3->count++;
        mpz_set(cl5030->fvar_4, ivar_2);
        mpz_set(cl5030->fvar_5, ivar_1);
        release_ltedfapeg_funtype_35(ivar_5);
        release_ltedfapeg_funtype_37(ivar_7);
        release_ltedfapeg_funtype_34(ivar_3);
        result = (ltedfapeg_funtype_33_t)cl5030;

        
        return result;
}

ltedfapeg_funtype_33_t ltedfapeg__REDUCE_nat__2(ltedfapeg_funtype_33_t ivar_1, ltedfapeg_funtype_33_t ivar_3, ltedfapeg_funtype_40_t ivar_5, ltedfapeg_funtype_42_t ivar_7, ltedfapeg_funtype_44_t ivar_9){
        ltedfapeg_funtype_33_t  result;
        ltedfapeg_closure_45_t cl5056;
        cl5056 = new_ltedfapeg_closure_45();
        cl5056->fvar_1 = (ltedfapeg_funtype_42_t)ivar_7;
        if (cl5056->fvar_1 != NULL) cl5056->fvar_1->count++;
        cl5056->fvar_2 = (ltedfapeg_funtype_44_t)ivar_9;
        if (cl5056->fvar_2 != NULL) cl5056->fvar_2->count++;
        cl5056->fvar_3 = (ltedfapeg_funtype_40_t)ivar_5;
        if (cl5056->fvar_3 != NULL) cl5056->fvar_3->count++;
        cl5056->fvar_4 = (ltedfapeg_funtype_33_t)ivar_3;
        if (cl5056->fvar_4 != NULL) cl5056->fvar_4->count++;
        cl5056->fvar_5 = (ltedfapeg_funtype_33_t)ivar_1;
        if (cl5056->fvar_5 != NULL) cl5056->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_33_t)cl5056;

        
        return result;
}

ltedfapeg_funtype_46_t ltedfapeg__reduce_ordinal__2(ordstruct_adt__ordstruct_adt_t ivar_1, ordstruct_adt__ordstruct_adt_t ivar_2, ltedfapeg_funtype_47_t ivar_3, ltedfapeg_funtype_48_t ivar_5, ltedfapeg_funtype_49_t ivar_7){
        ltedfapeg_funtype_46_t  result;
        ltedfapeg_closure_50_t cl5067;
        cl5067 = new_ltedfapeg_closure_50();
        cl5067->fvar_1 = (ltedfapeg_funtype_48_t)ivar_5;
        if (cl5067->fvar_1 != NULL) cl5067->fvar_1->count++;
        cl5067->fvar_2 = (ltedfapeg_funtype_49_t)ivar_7;
        if (cl5067->fvar_2 != NULL) cl5067->fvar_2->count++;
        cl5067->fvar_3 = (ltedfapeg_funtype_47_t)ivar_3;
        if (cl5067->fvar_3 != NULL) cl5067->fvar_3->count++;
        cl5067->fvar_4 = (ordstruct_adt__ordstruct_adt_t)ivar_2;
        if (cl5067->fvar_4 != NULL) cl5067->fvar_4->count++;
        cl5067->fvar_5 = (ordstruct_adt__ordstruct_adt_t)ivar_1;
        if (cl5067->fvar_5 != NULL) cl5067->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_46_t)cl5067;

        
        return result;
}

ltedfapeg_funtype_46_t ltedfapeg__REDUCE_ordinal__2(ltedfapeg_funtype_46_t ivar_1, ltedfapeg_funtype_46_t ivar_3, ltedfapeg_funtype_51_t ivar_5, ltedfapeg_funtype_52_t ivar_7, ltedfapeg_funtype_53_t ivar_9){
        ltedfapeg_funtype_46_t  result;
        ltedfapeg_closure_54_t cl5093;
        cl5093 = new_ltedfapeg_closure_54();
        cl5093->fvar_1 = (ltedfapeg_funtype_52_t)ivar_7;
        if (cl5093->fvar_1 != NULL) cl5093->fvar_1->count++;
        cl5093->fvar_2 = (ltedfapeg_funtype_53_t)ivar_9;
        if (cl5093->fvar_2 != NULL) cl5093->fvar_2->count++;
        cl5093->fvar_3 = (ltedfapeg_funtype_51_t)ivar_5;
        if (cl5093->fvar_3 != NULL) cl5093->fvar_3->count++;
        cl5093->fvar_4 = (ltedfapeg_funtype_46_t)ivar_3;
        if (cl5093->fvar_4 != NULL) cl5093->fvar_4->count++;
        cl5093->fvar_5 = (ltedfapeg_funtype_46_t)ivar_1;
        if (cl5093->fvar_5 != NULL) cl5093->fvar_5->count++;
        ...
        result = (ltedfapeg_funtype_46_t)cl5093;

        
        return result;
}

ltedfapeg_funtype_55_t ltedfapeg__good_good_entryp(uint32_t ivar_1, uint32_t ivar_2){
        ltedfapeg_funtype_55_t  result;
        ltedfapeg_closure_56_t cl5095;
        cl5095 = new_ltedfapeg_closure_56();
        cl5095->fvar_1 = (uint32_t)ivar_2;
        cl5095->fvar_2 = (uint32_t)ivar_1;
        result = (ltedfapeg_funtype_55_t)cl5095;

        
        return result;
}

ltedfapeg_funtype_55_t ltedfapeg__good_push_entryp(uint32_t ivar_1){
        ltedfapeg_funtype_55_t  result;
        ltedfapeg_closure_57_t cl5096;
        cl5096 = new_ltedfapeg_closure_57();
        cl5096->fvar_1 = (uint32_t)ivar_1;
        result = (ltedfapeg_funtype_55_t)cl5096;

        
        return result;
}

ltedfapeg_funtype_55_t ltedfapeg__fine_push_entryp(uint32_t ivar_1){
        ltedfapeg_funtype_55_t  result;
        ltedfapeg_closure_58_t cl5097;
        cl5097 = new_ltedfapeg_closure_58();
        cl5097->fvar_1 = (uint32_t)ivar_1;
        result = (ltedfapeg_funtype_55_t)cl5097;

        
        return result;
}

ltedfapeg_funtype_55_t ltedfapeg__nice_entryp(uint32_t ivar_1, uint32_t ivar_2){
        ltedfapeg_funtype_55_t  result;
        ltedfapeg_closure_59_t cl5100;
        cl5100 = new_ltedfapeg_closure_59();
        cl5100->fvar_1 = (uint32_t)ivar_2;
        cl5100->fvar_2 = (uint32_t)ivar_1;
        result = (ltedfapeg_funtype_55_t)cl5100;

        
        return result;
}

bool_t ltedfapeg__loop_or_pushp(ltedfapeg__ent_adt_t ivar_1){
        bool_t  result;
        bool_t ivar_2;
        ivar_1->count++;
...
ltedfapeg_funtype_60_t ltedfapeg__instack(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2){
        ltedfapeg_funtype_60_t  result;
        ltedfapeg_closure_63_t cl5110;
        cl5110 = new_ltedfapeg_closure_63();
        cl5110->fvar_1 = (ltedfapeg_array_62_t)ivar_2;
        if (cl5110->fvar_1 != NULL) cl5110->fvar_1->count++;
        cl5110->fvar_2 = (uint32_t)ivar_1;
        release_ltedfapeg_array_62(ivar_2);
        result = (ltedfapeg_funtype_60_t)cl5110;

        
        return result;
}

ltedfapeg_funtype_65_t ltedfapeg__successor(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_62_t ivar_3){
        ltedfapeg_funtype_65_t  result;
        ltedfapeg_closure_67_t cl5120;
        cl5120 = new_ltedfapeg_closure_67();
        cl5120->fvar_1 = (ltedfapeg_array_62_t)ivar_3;
        if (cl5120->fvar_1 != NULL) cl5120->fvar_1->count++;
        cl5120->fvar_2 = (uint32_t)ivar_1;
        cl5120->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5120->fvar_3 != NULL) cl5120->fvar_3->count++;
        release_ltedfapeg_array_62(ivar_3);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_65_t)cl5120;

        
        return result;
}

ltedfapeg_funtype_68_t ltedfapeg__sigma(uint32_t ivar_1, ltedfapeg_array_69_t ivar_2){
        ltedfapeg_funtype_68_t  result;
        ltedfapeg_closure_70_t cl5129;
        cl5129 = new_ltedfapeg_closure_70();
        cl5129->fvar_1 = (ltedfapeg_array_69_t)ivar_2;
        if (cl5129->fvar_1 != NULL) cl5129->fvar_1->count++;
        cl5129->fvar_2 = (uint32_t)ivar_1;
        release_ltedfapeg_array_69(ivar_2);
        result = (ltedfapeg_funtype_68_t)cl5129;

        
        return result;
}

uint64_t ltedfapeg__scafcount(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2, ltedfapeg_funtype_55_t ivar_4, uint32_t ivar_6){
        uint64_t  result;
        ...
        size5140 = (uint32_t)ivar_1;
        size5140 += 1;
        ivar_46 = new_ltedfapeg_array_69(size5140);
        uint32_t ivar_14;
        for (uint32_t index5139 = 0; index5139 < size5140; index5139++){
             ivar_14 = (uint32_t)index5139;
             ...
             ivar_41->count++;
             mpz_mk_set_ui(ivar_46->elems[index5139], ivar_23->ftbl->fptr(ivar_23, ivar_41));
             ivar_23->ftbl->rptr(ivar_23);
        };
...
uint64_t ltedfapeg__pushcount(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2){
        uint64_t  result;
        ltedfapeg_funtype_55_t ivar_15;
        ltedfapeg_closure_73_t cl5144;
        cl5144 = new_ltedfapeg_closure_73();
        ivar_15 = (ltedfapeg_funtype_55_t)cl5144;
...
bool_t ltedfapeg__good_or_failp(ltedfapeg__ent_adt_t ivar_1){
        bool_t  result;
        bool_t ivar_2;
        ivar_1->count++;
...
uint64_t ltedfapeg__gfcount(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2){
        uint64_t  result;
        ltedfapeg_funtype_55_t ivar_16;
        ltedfapeg_closure_74_t cl5148;
        cl5148 = new_ltedfapeg_closure_74();
        ivar_16 = (ltedfapeg_funtype_55_t)cl5148;
...
ltedfapeg_funtype_75_t ltedfapeg__good_depthp(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2){
        ltedfapeg_funtype_75_t  result;
        ltedfapeg_closure_76_t cl5151;
        cl5151 = new_ltedfapeg_closure_76();
        cl5151->fvar_1 = (ltedfapeg_array_62_t)ivar_2;
        if (cl5151->fvar_1 != NULL) cl5151->fvar_1->count++;
        cl5151->fvar_2 = (uint32_t)ivar_1;
        release_ltedfapeg_array_62(ivar_2);
        result = (ltedfapeg_funtype_75_t)cl5151;

        
        return result;
}

ltedfapeg_funtype_55_t ltedfapeg__good_stackp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, uint64_t ivar_3, ltedfapeg_array_62_t ivar_4){
        ltedfapeg_funtype_55_t  result;
        ltedfapeg_closure_77_t cl5160;
        cl5160 = new_ltedfapeg_closure_77();
        cl5160->fvar_1 = (ltedfapeg_array_62_t)ivar_4;
        if (cl5160->fvar_1 != NULL) cl5160->fvar_1->count++;
        cl5160->fvar_2 = (uint32_t)ivar_1;
        cl5160->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5160->fvar_3 != NULL) cl5160->fvar_3->count++;
        cl5160->fvar_4 = (uint64_t)ivar_3;
        release_ltedfapeg_array_62(ivar_4);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_55_t)cl5160;

        
        return result;
}

ltedfapeg_funtype_65_t ltedfapeg__mem_stackp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, uint64_t ivar_3, ltedfapeg_array_62_t ivar_4){
        ltedfapeg_funtype_65_t  result;
        ltedfapeg_closure_78_t cl5172;
        cl5172 = new_ltedfapeg_closure_78();
        cl5172->fvar_1 = (ltedfapeg_array_62_t)ivar_4;
        if (cl5172->fvar_1 != NULL) cl5172->fvar_1->count++;
        cl5172->fvar_2 = (uint32_t)ivar_1;
        cl5172->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5172->fvar_3 != NULL) cl5172->fvar_3->count++;
        cl5172->fvar_4 = (uint64_t)ivar_3;
        release_ltedfapeg_array_62(ivar_4);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_65_t)cl5172;

        
        return result;
}

bool_t ltedfapeg__push_or_pendingp(ltedfapeg__ent_adt_t ivar_1){
        bool_t  result;
        bool_t ivar_2;
        ivar_1->count++;
...
ltedfapeg_funtype_55_t ltedfapeg__fine_stackp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, uint64_t ivar_3, ltedfapeg_array_62_t ivar_4){
        ltedfapeg_funtype_55_t  result;
        ltedfapeg_closure_79_t cl5182;
        cl5182 = new_ltedfapeg_closure_79();
        cl5182->fvar_1 = (ltedfapeg_array_62_t)ivar_4;
        if (cl5182->fvar_1 != NULL) cl5182->fvar_1->count++;
        cl5182->fvar_2 = (uint32_t)ivar_1;
        cl5182->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5182->fvar_3 != NULL) cl5182->fvar_3->count++;
        cl5182->fvar_4 = (uint64_t)ivar_3;
        release_ltedfapeg_array_62(ivar_4);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_55_t)cl5182;

        
        return result;
}

bool_t ltedfapeg__loop_readyp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_62_t ivar_3, uint32_t ivar_5, uint8_t ivar_6){
        bool_t  result;
...
ltedfapeg_funtype_81_t ltedfapeg__good_failp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ltedfapeg_funtype_81_t  result;
        ltedfapeg_closure_83_t cl5221;
        cl5221 = new_ltedfapeg_closure_83();
        cl5221->fvar_1 = (ltedfapeg_array_82_t)ivar_3;
        if (cl5221->fvar_1 != NULL) cl5221->fvar_1->count++;
        cl5221->fvar_2 = (uint32_t)ivar_1;
        cl5221->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5221->fvar_3 != NULL) cl5221->fvar_3->count++;
        release_ltedfapeg_array_82(ivar_3);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_81_t)cl5221;

        
        return result;
}

ltedfapeg_funtype_85_t ltedfapeg__good_loopp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2){
        ltedfapeg_funtype_85_t  result;
        ltedfapeg_closure_86_t cl5239;
        cl5239 = new_ltedfapeg_closure_86();
        cl5239->fvar_1 = (uint32_t)ivar_1;
        cl5239->fvar_2 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5239->fvar_2 != NULL) cl5239->fvar_2->count++;
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_85_t)cl5239;

        
        return result;
}

ltedfapeg_funtype_88_t ltedfapeg__good_goodp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ltedfapeg_funtype_88_t  result;
        ltedfapeg_closure_89_t cl5278;
        cl5278 = new_ltedfapeg_closure_89();
        cl5278->fvar_1 = (ltedfapeg_array_82_t)ivar_3;
        if (cl5278->fvar_1 != NULL) cl5278->fvar_1->count++;
        cl5278->fvar_2 = (uint32_t)ivar_1;
        cl5278->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5278->fvar_3 != NULL) cl5278->fvar_3->count++;
        release_ltedfapeg_array_82(ivar_3);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_88_t)cl5278;

        
        return result;
}

ltedfapeg_funtype_91_t ltedfapeg__good_entryp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ltedfapeg_funtype_91_t  result;
        ltedfapeg_closure_92_t cl5327;
        cl5327 = new_ltedfapeg_closure_92();
        cl5327->fvar_1 = (uint32_t)ivar_1;
        cl5327->fvar_2 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5327->fvar_2 != NULL) cl5327->fvar_2->count++;
        cl5327->fvar_3 = (ltedfapeg_array_82_t)ivar_3;
        if (cl5327->fvar_3 != NULL) cl5327->fvar_3->count++;
        release_ltedfapeg__lang_spec(ivar_2);
        release_ltedfapeg_array_82(ivar_3);
        result = (ltedfapeg_funtype_91_t)cl5327;

        
        return result;
}

ltedfapeg_funtype_91_t ltedfapeg__fine_entryp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ltedfapeg_funtype_91_t  result;
        ltedfapeg_closure_93_t cl5377;
        cl5377 = new_ltedfapeg_closure_93();
        cl5377->fvar_1 = (uint32_t)ivar_1;
        cl5377->fvar_2 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5377->fvar_2 != NULL) cl5377->fvar_2->count++;
        cl5377->fvar_3 = (ltedfapeg_array_82_t)ivar_3;
        if (cl5377->fvar_3 != NULL) cl5377->fvar_3->count++;
        release_ltedfapeg__lang_spec(ivar_2);
        release_ltedfapeg_array_82(ivar_3);
        result = (ltedfapeg_funtype_91_t)cl5377;

        
        return result;
}

ltedfapeg_funtype_94_t ltedfapeg__good_tscaffoldp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ltedfapeg_funtype_94_t  result;
        ltedfapeg_closure_95_t cl5399;
        cl5399 = new_ltedfapeg_closure_95();
        cl5399->fvar_1 = (uint32_t)ivar_1;
        result = (ltedfapeg_funtype_94_t)cl5399;

        
        return result;
}

ltedfapeg_funtype_60_t ltedfapeg__good_rootp(uint32_t ivar_1, ltedfapeg_array_62_t ivar_2){
        ltedfapeg_funtype_60_t  result;
        ltedfapeg_closure_96_t cl5408;
        cl5408 = new_ltedfapeg_closure_96();
        cl5408->fvar_1 = (ltedfapeg_array_62_t)ivar_2;
        if (cl5408->fvar_1 != NULL) cl5408->fvar_1->count++;
        cl5408->fvar_2 = (uint32_t)ivar_1;
        release_ltedfapeg_array_62(ivar_2);
        result = (ltedfapeg_funtype_60_t)cl5408;

        
        return result;
}

ltedfapeg_funtype_97_t ltedfapeg__fine_scaffoldp(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3){
        ltedfapeg_funtype_97_t  result;
        ltedfapeg_closure_98_t cl5430;
        cl5430 = new_ltedfapeg_closure_98();
        cl5430->fvar_1 = (ltedfapeg_array_82_t)ivar_3;
        if (cl5430->fvar_1 != NULL) cl5430->fvar_1->count++;
        cl5430->fvar_2 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5430->fvar_2 != NULL) cl5430->fvar_2->count++;
        cl5430->fvar_3 = (uint32_t)ivar_1;
        release_ltedfapeg_array_82(ivar_3);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_97_t)cl5430;

        
        return result;
}

bool_t ltedfapeg__emptyp(ltedfapeg__ent_adt_t ivar_1){
        bool_t  result;
        uint8_t ivar_2;
...
ltedfapeg_funtype_101_t ltedfapeg__step(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3, uint32_t ivar_4, uint8_t ivar_5){
        ltedfapeg_funtype_101_t  result;
        ltedfapeg_closure_102_t cl5588;
        cl5588 = new_ltedfapeg_closure_102();
        cl5588->fvar_1 = (uint32_t)ivar_1;
        cl5588->fvar_2 = (ltedfapeg_array_82_t)ivar_3;
        if (cl5588->fvar_2 != NULL) cl5588->fvar_2->count++;
        cl5588->fvar_3 = (ltedfapeg__lang_spec_t)ivar_2;
        if (cl5588->fvar_3 != NULL) cl5588->fvar_3->count++;
        release_ltedfapeg_array_82(ivar_3);
        release_ltedfapeg__lang_spec(ivar_2);
        result = (ltedfapeg_funtype_101_t)cl5588;

        
        return result;
}

ltedfapeg_funtype_103_t ltedfapeg__size(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3, uint32_t ivar_4, uint8_t ivar_5){
        ltedfapeg_funtype_103_t  result;
        ltedfapeg_closure_104_t cl5615;
        cl5615 = new_ltedfapeg_closure_104();
        cl5615->fvar_1 = (uint32_t)ivar_1;
        result = (ltedfapeg_funtype_103_t)cl5615;

        
        return result;
}

ltedfapeg_record_100_t ltedfapeg__parse(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3, uint32_t ivar_4, uint8_t ivar_5, ltedfapeg_record_100_t ivar_6){
        ltedfapeg_record_100_t  result;
        bool_t ivar_9;
        uint64_t ivar_10;
...
ltedfapeg__ent_adt_t ltedfapeg__doparse(uint32_t ivar_1, ltedfapeg__lang_spec_t ivar_2, ltedfapeg_array_82_t ivar_3, uint8_t ivar_4){
        ltedfapeg__ent_adt_t  result;
        /* pend */ ltedfapeg_funtype_106_t ivar_5;
        ltedfapeg_closure_107_t cl5727;
        cl5727 = new_ltedfapeg_closure_107();
        ivar_5 = (ltedfapeg_funtype_106_t)cl5727;
        ltedfapeg_record_109_t ivar_82;
        uint8_t ivar_16;
        ivar_16 = (uint8_t)1;
        bool_t ivar_17;
        ivar_17 = (bool_t) false;
        ltedfapeg_funtype_108_t ivar_45;
        ...
        ltedfapeg_funtype_108_t ivar_33;
        ltedfapeg_closure_110_t cl5728;
        cl5728 = new_ltedfapeg_closure_110();
        cl5728->fvar_1 = (uint32_t)ivar_1;
        cl5728->fvar_2 = (ltedfapeg_funtype_106_t)ivar_5;
        if (cl5728->fvar_2 != NULL) cl5728->fvar_2->count++;
        release_ltedfapeg_funtype_106(ivar_5);
        ivar_33 = (ltedfapeg_funtype_108_t)cl5728;
        uint32_t ivar_40;
        ivar_40 = (uint32_t)0;
        ltedfapeg_funtype_106_t ivar_34;
        ivar_34 = (ltedfapeg_funtype_106_t)ivar_33->ftbl->fptr(ivar_33, ivar_40);
        ltedfapeg_funtype_108_t ivar_41;
        ltedfapeg_funtype_106_t ivar_43;
        ivar_43 = NULL;
        ivar_41 = (ltedfapeg_funtype_108_t)update_ltedfapeg_funtype_108(ivar_33, ivar_40, ivar_43);
        if (ivar_43 != NULL) ivar_43->count--;
        ltedfapeg_funtype_106_t ivar_42;
        ltedfapeg_funtype_106_t ivar_37;
        ltedfapeg__ent_adt_t ivar_39;
        ivar_39 = NULL;
        ivar_37 = (ltedfapeg_funtype_106_t)update_ltedfapeg_funtype_106(ivar_34, ivar_4, ivar_39);
        if (ivar_39 != NULL) ivar_39->count--;
        ivar_42 = (ltedfapeg_funtype_106_t)update_ltedfapeg_funtype_106(ivar_37, ivar_4, ivar_25);
        if (ivar_25 != NULL) ivar_25->count--;
        ivar_45 = (ltedfapeg_funtype_108_t)update_ltedfapeg_funtype_108(ivar_41, ivar_40, ivar_42);
        ...
        ltedfapeg_record_109_t tmp5729 = new_ltedfapeg_record_109();;
        ivar_82 = (ltedfapeg_record_109_t)tmp5729;
        tmp5729->depth = (uint8_t)ivar_16;
        tmp5729->lflag = (bool_t)ivar_17;
        tmp5729->scaf = (ltedfapeg_funtype_108_t)ivar_45;
        tmp5729->stack = (ltedfapeg__ent_adt_t)ivar_53;
        /* St */ ltedfapeg_record_100_t ivar_10;
        //copying to ltedfapeg_record_100 from ltedfapeg_record_109;
        {
         ivar_10 = new_ltedfapeg_record_100();
         uint32_t tmp5730;
         //copying to uint32 from uint32;
         tmp5730 = (uint32_t)ivar_1;
         tmp5730 += 1;
         ivar_10->scaf = new_ltedfapeg_array_62(tmp5730);
         for (uint32_t index_83 = 0; index_83 < tmp5730; index_83++){
                 uint32_t tmp5731;
                 tmp5731 = (uint32_t)255;
                 ivar_10->scaf->elems[index_83] = new_ltedfapeg_array_61(tmp5731);
                 for (uint32_t index_84 = 0; index_84 < tmp5731; index_84++){
         ...
         ltedfapeg_array_62_t scaf5691;
         scaf5691 = (ltedfapeg_array_62_t)ivar_10->scaf;
         ivar_10->depth = (uint64_t)ivar_82->depth;
         uint64_t depth5692;
         depth5692 = (uint64_t)ivar_10->depth;
         ivar_10->stack = (ltedfapeg__ent_adt_t)ivar_82->stack;
         if (ivar_10->stack != NULL) ivar_10->stack->count++;
         ltedfapeg__ent_adt_t stack5693;
         stack5693 = (ltedfapeg__ent_adt_t)ivar_10->stack;
         ivar_10->lflag = (bool_t)ivar_82->lflag;
         bool_t lflag5694;
         lflag5694 = (bool_t)ivar_10->lflag;
        };
        release_ltedfapeg_record_109(ivar_82);
