...
int main(){
 ...
 /*  printf("\n readfile = %u, CPU Time = %f seconds\n; CPU Cycles = %llu\n", test0, end0 - end1, endcyc0 - endcyc1); */
  ...
  //Pure file parsing with no proof-of-parse construction
 ...
 /*  // File parsing with proof-of-parse construction   */
 /*  double start2 = get_cpu_time(); */
 /*  uint64_t start2cyc = cpucycles(); */
 ...
 /*  printf("\n CPU Time = %f seconds\n; CPU Cycles = %llu\n", end2 - start2, end2cyc - start2cyc); */
 /*    // File parsing with proof-of-parse construction and checking */
 /*  double start3 = get_cpu_time(); */
 /*  uint64_t start3cyc = cpucycles(); */
 ...
 /*  printf("\n result = %u, CPU Time = %f seconds\n; CPU Cycles = %llu\n", test5, end3 - start3, end3cyc - start3cyc); */
  /* double start4 = get_cpu_time(); */
  /* ltedfapegproof__parsetree_adt_t test6 = ltedfapegtest__jsonparsefile(make_bytestring("patient-example.json")); */
  /* printf("\ntest6 = %s", json_ltedfapegproof__parsetree_adt(test6)); */
  bool_t test7 =  ltedfapegtest__jsonparsecheckfile(make_bytestring("fhir.schema.json"));
  double end4 = get_cpu_time();
  printf("\n Patient parsed result = %u\n", test7);
