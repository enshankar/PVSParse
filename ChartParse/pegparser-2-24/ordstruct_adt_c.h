...
//cc -O3 -Wall -o ordstruct_adt -I /Users/e21660/shankar/pvs.git//include /Users/e21660/shankar/pvs.git//lib/pvslib.c  -I /Users/e21660/shankar/pvs.git/lib /Users/e21660/shankar/pvs.git/lib/ordstruct_adt_c.c -lgmp 
//ordstruct
...
extern char* json_ordstruct_adt_funtype_3(ordstruct_adt_funtype_3_t x);
...
extern char * json_ordstruct_adt_record_4(ordstruct_adt_record_4_t x);

typedef struct actual_ordstruct_adt_record_4_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr; json_ptr_t json_ptr;} * actual_ordstruct_adt_record_4_t;
extern void release_ordstruct_adt_record_4_ptr(pointer_t x, type_actual_t ordstruct_adt_record_4);

extern bool_t equal_ordstruct_adt_record_4_ptr(pointer_t x, pointer_t y, actual_ordstruct_adt_record_4_t T);

extern char * json_ordstruct_adt_record_4_ptr(pointer_t x,  actual_ordstruct_adt_record_4_t T);
...
extern char* json_ordstruct_adt_funtype_5(ordstruct_adt_funtype_5_t x);
...
extern char * json_ordstruct_adt_record_7(ordstruct_adt_record_7_t x);

typedef struct actual_ordstruct_adt_record_7_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr; json_ptr_t json_ptr;} * actual_ordstruct_adt_record_7_t;
extern void release_ordstruct_adt_record_7_ptr(pointer_t x, type_actual_t ordstruct_adt_record_7);

extern bool_t equal_ordstruct_adt_record_7_ptr(pointer_t x, pointer_t y, actual_ordstruct_adt_record_7_t T);

extern char * json_ordstruct_adt_record_7_ptr(pointer_t x,  actual_ordstruct_adt_record_7_t T);
...
extern char* json_ordstruct_adt_funtype_8(ordstruct_adt_funtype_8_t x);
...
extern mpz_ptr_t h_ordstruct_adt_closure_9(ordstruct_adt__ordstruct_adt_t ivar_6, ordstruct_adt_funtype_8_t ivar_3, ordstruct_adt_funtype_3_t ivar_1);
...
extern ordstruct_adt_funtype_3_t ordstruct_adt__REDUCE_nat(ordstruct_adt_funtype_3_t ivar_1, ordstruct_adt_funtype_8_t ivar_3);
#endif