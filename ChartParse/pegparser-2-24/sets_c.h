...
struct sets_closure_5_s {uint32_t count;
         ...
         sets__set_htbl_t htbl;
        type_actual_t fvar_1;
        sets__set_t fvar_2; type_actual_t sets__T;};
...
extern bool_t h_sets_closure_5(sets__T_t ivar_2, type_actual_t sets__T, sets__set_t ivar_1);
...
struct sets_closure_10_s {uint32_t count;
         ...
         sets__set_htbl_t htbl;
        type_actual_t fvar_1;
        sets__T_t fvar_2; type_actual_t sets__T;};
...
extern bool_t h_sets_closure_10(sets__T_t ivar_2, type_actual_t sets__T, sets__T_t ivar_1);
...
extern bool_t h_sets_closure_13(sets__T_t ivar_3, type_actual_t sets__T, sets__set_t ivar_1);
