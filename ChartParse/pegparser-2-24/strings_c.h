...
extern uint32_t lookup_strings_funtype_3(strings_funtype_3_htbl_t htbl, uint32_t i, uint32_t ihash);

extern strings_funtype_3_t dupdate_strings_funtype_3(strings_funtype_3_t a, uint32_t i, uint32_t v);
...
extern char* json_strings_funtype_3(strings_funtype_3_t x);
