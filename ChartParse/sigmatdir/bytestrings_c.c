...
extern bytestrings__bytestring_t bytestrings__null(void){
        ...
        size24655 = (uint32_t)ivar_1;
        size24655 += 0;
        ivar_6 = new_bytestrings_array_0(size24655);
        uint8_t ivar_5;
        for (uint32_t index24654 = 0; index24654 < size24655; index24654++){
             ivar_5 = (uint8_t)index24654;
             ivar_6->elems[index24654] = (uint8_t)0;
        };
        bytestrings__bytestring_t tmp24660 = new_bytestrings__bytestring();;
        result = (bytestrings__bytestring_t)tmp24660;
        tmp24660->length = (uint32_t)ivar_1;
        tmp24660->seq = (bytestrings_array_0_t)ivar_6;
...
extern bytestrings__bytestring_t bytestrings__unit(uint8_t ivar_1){
        ...
        uint32_t size24670;
        //copying to uint32 from uint32;
        size24670 = (uint32_t)ivar_2;
        size24670 += 0;
        ivar_6 = new_bytestrings_array_0(size24670);
        uint8_t ivar_5;
        for (uint32_t index24669 = 0; index24669 < size24670; index24669++){
             ivar_5 = (uint8_t)index24669;
             //copying to uint8 from uint8;
             ivar_6->elems[index24669] = (uint8_t)ivar_1;
        };
        bytestrings__bytestring_t tmp24675 = new_bytestrings__bytestring();;
        result = (bytestrings__bytestring_t)tmp24675;
        tmp24675->length = (uint32_t)ivar_2;
        tmp24675->seq = (bytestrings_array_0_t)ivar_6;
...
extern bytestrings__bytestring_t bytestrings__mk_bytestring(strings__string_t ivar_1){
        ...
        uint32_t size24697;
        //copying to uint32 from uint32;
        size24697 = (uint32_t)ivar_3;
        size24697 += 0;
        ivar_18 = new_bytestrings_array_0(size24697);
        for (uint32_t index24692 = 0; index24692 < size24697; index24692++){
             mpz_t ivar_8;
             mpz_init(ivar_8);
             mpz_set_ui(ivar_8, index24692);
             uint32_t ivar_10;
             ivar_1->count++;
             ivar_10 = (uint32_t)gen_strings__get((strings__string_t)ivar_1, (mpz_ptr_t)ivar_8);
             ivar_18->elems[index24692] = (uint32_t) ivar_10;
        };
        release_strings__string(ivar_1);
        bytestrings__bytestring_t tmp24702 = new_bytestrings__bytestring();;
        result = (bytestrings__bytestring_t)tmp24702;
        tmp24702->length = (uint32_t)ivar_3;
        tmp24702->seq = (bytestrings_array_0_t)ivar_18;
...
extern bytestrings__bytestring_t bytestrings__doubleplus(bytestrings__bytestring_t ivar_1, bytestrings__bytestring_t ivar_2){
        ...
        if (ivar_3){ 
           ...
           uint32_t size24753;
           //copying to uint32 from uint32;
           size24753 = (uint32_t)ivar_13;
           size24753 += 0;
           ivar_46 = new_bytestrings_array_0(size24753);
           uint32_t ivar_22;
           for (uint32_t index24744 = 0; index24744 < size24753; index24744++){
           ivar_22 = (uint32_t)index24744;
           bool_t ivar_23;
           uint32_t ivar_25;
           ...
           if (ivar_23){    
            ivar_1->count++;
            ivar_46->elems[index24744] = (uint8_t)bytestrings__get((bytestrings__bytestring_t)ivar_1, (uint32_t)ivar_22);
} else {
            ...
            ivar_2->count++;
            ivar_46->elems[index24744] = (uint8_t)bytestrings__get((bytestrings__bytestring_t)ivar_2, (uint32_t)ivar_42);
};
           };
           release_bytestrings__bytestring(ivar_2);
           release_bytestrings__bytestring(ivar_1);
           bytestrings__bytestring_t tmp24758 = new_bytestrings__bytestring();;
           result = (bytestrings__bytestring_t)tmp24758;
           tmp24758->length = (uint32_t)ivar_13;
           tmp24758->seq = (bytestrings_array_0_t)ivar_46;
};
};
...
extern bytestrings__bytestring_t bytestrings__prefix(bytestrings__bytestring_t ivar_1, uint32_t ivar_2){
        ...
        if (ivar_4){ 
             ...
             uint32_t size24860;
             //copying to uint32 from uint32;
             size24860 = (uint32_t)ivar_2;
             size24860 += 0;
             ivar_22 = new_bytestrings_array_0(size24860);
             uint32_t ivar_14;
             for (uint32_t index24855 = 0; index24855 < size24860; index24855++){
           ivar_14 = (uint32_t)index24855;
           ivar_1->count++;
           ivar_22->elems[index24855] = (uint8_t)bytestrings__get((bytestrings__bytestring_t)ivar_1, (uint32_t)ivar_14);
             };
             release_bytestrings__bytestring(ivar_1);
             bytestrings__bytestring_t tmp24865 = new_bytestrings__bytestring();;
             result = (bytestrings__bytestring_t)tmp24865;
             tmp24865->length = (uint32_t)ivar_2;
             tmp24865->seq = (bytestrings_array_0_t)ivar_22;
};
...
extern bytestrings__bytestring_t bytestrings__suffix(bytestrings__bytestring_t ivar_1, uint32_t ivar_2){
        ...
        if (ivar_4){ 
             ...
             uint32_t size24897;
             //copying to uint32 from uint32;
             size24897 = (uint32_t)ivar_12;
             size24897 += 0;
             ivar_39 = new_bytestrings_array_0(size24897);
             for (uint32_t index24892 = 0; index24892 < size24897; index24892++){
           mpz_t ivar_23;
           mpz_init(ivar_23);
           mpz_set_ui(ivar_23, index24892);
           mpz_ptr_t ivar_38;
           ...
           mpz_clear(ivar_38);
           ivar_1->count++;
           ivar_39->elems[index24892] = (uint8_t)bytestrings__get((bytestrings__bytestring_t)ivar_1, (uint32_t)ivar_35);
             };
             release_bytestrings__bytestring(ivar_1);
             bytestrings__bytestring_t tmp24902 = new_bytestrings__bytestring();;
             result = (bytestrings__bytestring_t)tmp24902;
             tmp24902->length = (uint32_t)ivar_12;
             tmp24902->seq = (bytestrings_array_0_t)ivar_39;
};
...
extern bool_t bytestrings__ascii_bytestringp(bytestrings__bytestring_t ivar_1){
        ...
        highvar24930 = (uint32_t)ivar_3->length;
        highvar24930 += 0;
        for (uint32_t ivar_2 = low24929; ivar_2 < highvar24930; ivar_2++){
             uint8_t ivar_4;
             ivar_1->count++;
