...
extern char* json_file_funtype_5(file_funtype_5_t x);
...
extern char * json_file_record_7(file_record_7_t x);

typedef struct actual_file_record_7_s {equal_ptr_t equal_ptr; release_ptr_t release_ptr; json_ptr_t json_ptr;} * actual_file_record_7_t;
...
extern char * json_file_record_7_ptr(pointer_t x,  actual_file_record_7_t T);
...
extern char* json_file_funtype_8(file_funtype_8_t x);
...
extern char* json_file_funtype_11(file_funtype_11_t x);
...
extern char* json_file_funtype_13(file_funtype_13_t x);
...
extern bytestrings__bytestring_t file__name(file__file_t f);

extern uint32_t file__file_size(file__file_t f);

extern file__lifted_file_adt_t file__open(bytestrings__bytestring_t name);

extern file__lifted_file_adt_t file__create(bytestrings__bytestring_t name);

extern file__lifted_file_adt_t file__setbyte(file__file_t f, uint32_t i, uint8_t b);
