...
extern ordinals_funtype_0_t ordinals__size(void){
        ...
        ordinals_closure_3_t cl23135;
        cl23135 = new_ordinals_closure_3();
        ivar_17 = (ordinals_funtype_2_t)cl23135;
...
extern bool_t ordinals__lessp(ordstruct_adt__ordstruct_adt_t ivar_1, ordstruct_adt__ordstruct_adt_t ivar_2){
        ...
        if (ivar_9){ 
           ...
           if (ivar_51){    
            int64_t tmp23171 = mpz_cmp(ivar_13, ivar_30);
            ivar_49 = (tmp23171 < 0);
} else {
           ...
           if (ivar_49){    
            ...
            if (ivar_60){     
             bool_t ivar_65;
             int64_t tmp23182 = mpz_cmp(ivar_13, ivar_30);
             ivar_65 = (tmp23182 == 0);
             if (ivar_65){      
