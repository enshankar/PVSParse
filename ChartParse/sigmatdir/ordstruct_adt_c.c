...
extern ordstruct_adt__ordstruct_adt_t ordstruct_adt__zero(void){
        ...
        if (!defined){
                    uint8_t ivar_1;
        ivar_1 = (uint8_t)0;
        ordstruct_adt__ordstruct_adt_t tmp22850 = new_ordstruct_adt__ordstruct_adt();;
        result = (ordstruct_adt__ordstruct_adt_t)tmp22850;
        tmp22850->ordstruct_adt__ordstruct_adt_index = (uint8_t)ivar_1;
...
extern ordstruct_adt__ordstruct_adt_t ordstruct_adt__add(mpz_ptr_t ivar_2, ordstruct_adt__ordstruct_adt_t ivar_3, ordstruct_adt__ordstruct_adt_t ivar_4){
        ...
        uint8_t ivar_1;
        ivar_1 = (uint8_t)1;
        ordstruct_adt__add_t tmp22870 = new_ordstruct_adt__add();;
        result = (ordstruct_adt__ordstruct_adt_t)tmp22870;
        tmp22870->ordstruct_adt__ordstruct_adt_index = (uint8_t)ivar_1;
        mpz_init(tmp22870->coef);
        mpz_set(tmp22870->coef, ivar_2);
        mpz_clear(ivar_2);
        tmp22870->exp = (ordstruct_adt__ordstruct_adt_t)ivar_3;
        tmp22870->rest = (ordstruct_adt__ordstruct_adt_t)ivar_4;
...
extern ordstruct_adt_funtype_3_t ordstruct_adt__reduce_nat(mpz_ptr_t ivar_1, ordstruct_adt_funtype_5_t ivar_2){
        ...
        ordstruct_adt_closure_6_t cl22997;
        cl22997 = new_ordstruct_adt_closure_6();
        cl22997->fvar_1 = (ordstruct_adt_funtype_5_t)ivar_2;
        if (cl22997->fvar_1 != NULL) cl22997->fvar_1->count++;
        mpz_set(cl22997->fvar_2, ivar_1);
        release_ordstruct_adt_funtype_5(ivar_2);
        result = (ordstruct_adt_funtype_3_t)cl22997;
...
extern ordstruct_adt_funtype_3_t ordstruct_adt__REDUCE_nat(ordstruct_adt_funtype_3_t ivar_1, ordstruct_adt_funtype_8_t ivar_3){
        ordstruct_adt_funtype_3_t  result;
        ordstruct_adt_closure_9_t cl23089;
        cl23089 = new_ordstruct_adt_closure_9();
        cl23089->fvar_1 = (ordstruct_adt_funtype_8_t)ivar_3;
        if (cl23089->fvar_1 != NULL) cl23089->fvar_1->count++;
        cl23089->fvar_2 = (ordstruct_adt_funtype_3_t)ivar_1;
        if (cl23089->fvar_2 != NULL) cl23089->fvar_2->count++;
        release_ordstruct_adt_funtype_8(ivar_3);
        release_ordstruct_adt_funtype_3(ivar_1);
        result = (ordstruct_adt_funtype_3_t)cl23089;
