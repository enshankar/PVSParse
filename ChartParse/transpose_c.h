...
//cc -O3 -Wall -o transpose -I /Users/e21660/shankar/pvs.git/src/groundeval/ /Users/e21660/shankar/pvs.git/src/groundeval/pvslib.c  -I /Users/e21660/shankar/pvs.git/lib transpose_c.c -lgmp 
...
extern void release_transpose_funtype_0(transpose_funtype_0_t x);

extern transpose_funtype_0_t copy_transpose_funtype_0(transpose_funtype_0_t x);

extern transpose_funtype_0_t equal_transpose_funtype_0(transpose_funtype_0_t x, transpose_funtype_0_t y);
...
extern void release_transpose_funtype_1(transpose_funtype_1_t x);

extern transpose_funtype_1_t copy_transpose_funtype_1(transpose_funtype_1_t x);

extern transpose_funtype_1_t equal_transpose_funtype_1(transpose_funtype_1_t x, transpose_funtype_1_t y);
...
extern void release_transpose_funtype_2(transpose_funtype_2_t x);

extern transpose_funtype_2_t copy_transpose_funtype_2(transpose_funtype_2_t x);

extern transpose_funtype_2_t equal_transpose_funtype_2(transpose_funtype_2_t x, transpose_funtype_2_t y);
...
extern void release_transpose_funtype_3(transpose_funtype_3_t x);

extern transpose_funtype_3_t copy_transpose_funtype_3(transpose_funtype_3_t x);

extern transpose_funtype_3_t equal_transpose_funtype_3(transpose_funtype_3_t x, transpose_funtype_3_t y);
...
extern transpose_closure_4_t new_transpose_closure_4(void);

extern void release_transpose_closure_4(transpose_funtype_1_t closure);

extern transpose_closure_4_t copy_transpose_closure_4(transpose_closure_4_t x);
...
extern transpose_closure_5_t new_transpose_closure_5(void);

extern void release_transpose_closure_5(transpose_funtype_0_t closure);

extern transpose_closure_5_t copy_transpose_closure_5(transpose_closure_5_t x);
